...
public class QuantitiesLabel extends Classifier
{
  ...
  public String discreteValue(Object __example)
  {
    if (!(__example instanceof Constituent))
    {
      ...
      System.err.println("Classifier 'QuantitiesLabel(Constituent)' defined on line 8 of chunk.lbj received '" + type + "' as input.");
  ...
  public int hashCode() { return "QuantitiesLabel".hashCode(); }
  public boolean equals(Object o) { return o instanceof QuantitiesLabel; }
}
