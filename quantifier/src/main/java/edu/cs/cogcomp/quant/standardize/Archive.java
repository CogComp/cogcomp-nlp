 ...
 */
package edu.cs.cogcomp.quant.standardize;
...
public class Archive {
    ...
    public static void initialize() {
        ...
        dateCheckPat =
                Pattern.compile("((\\d{1,4}|" + edu.cs.cogcomp.quant.standardize.Date.MONTH + ")\\s*[/\\-\\.]\\s*(\\d\\d?|"
                        + edu.cs.cogcomp.quant.standardize.Date.MONTH + ")\\s*[/\\-\\.]\\s*(\\d{1,4}|" + edu.cs.cogcomp.quant.standardize.Date.MONTH + "))",
                        Pattern.CASE_INSENSITIVE);
        ...
        monthOfPat =
                Pattern.compile("(" + edu.cs.cogcomp.quant.standardize.Date.MONTH + ")\\s*of\\s*(\\d{4}|\\d{2})",
                        Pattern.CASE_INSENSITIVE);
        fracToDoublePat =
