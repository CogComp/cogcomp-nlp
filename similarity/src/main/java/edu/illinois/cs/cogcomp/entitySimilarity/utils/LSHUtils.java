...
public class LSHUtils {
    ...
    /**
     * CURRENTLY A CASE SENSITIVE BIGRAM FIND
     * Todo : Ignore Case when getting bigrams ?????
     */
    ...
    public static double dice(String s1, String s2){ //List<char[]> bigram1, List<char[]> bigram2) {
    ...
    public static StringBuilder writeBigramBinaryVectors(List<String[]> head_docids) {
        ...
        for(String[] head_doc : head_docids){
            ...
            // Binary Array with size equal to the number of bigrams in corpus. Stores the number of existing background in the mention.
