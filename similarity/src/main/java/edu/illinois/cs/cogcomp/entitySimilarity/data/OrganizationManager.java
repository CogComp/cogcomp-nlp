...
public class OrganizationManager {
	...
	/**
	 * Constructor to initialize an OrganizationManager object. Used to identify strings that could
	 * be of type ORG and subsequently score them.
	 * 
	 * @param fileName	File name to obtain list of organization strings
	 * @throws IOException
	 */
	 ...
	 * 
	 * @param token	One of the two strings to be checked for type ORG
	 * @return	A boolean value (true/false) determining whether the string should be designated type ORG
	 */
