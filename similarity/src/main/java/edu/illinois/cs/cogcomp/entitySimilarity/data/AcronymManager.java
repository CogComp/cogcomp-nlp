...
import edu.illinois.cs.cogcomp.entitySimilarity.utils.DameraoLevenstein;
...
public class AcronymManager {
	...
	/**
	 * Constructor to initialize an AcronymManager object, which is used to determine if
	 * a string or a pair of strings should be assigned type ORG.
	 * 
	 * @param acronymFileName	File name to obtain list of acronyms
	 * @throws IOException
	 */
	 ...
	 * 
	 * @param name1	First of two type ORG strings to be compared
	 * @param name2	Second of two type ORG strings to be compared
	 ...
	 * Helper scoring function used to score strings designated ORG.
	 * 
	 * @param candidates1	ArrayList<String> for first string
	 * @param candidates2	ArrayList<String> for second string
	 * @return	Float value between 0 and 1 inclusive as the score
	 */
	...
	/**
	 * Primary scoring function called by EntityComparison. It scores pairs of strings of type ORG.
	 * 
	...
	public float scoring(NameInfo name1Info, NameInfo name2Info) {
		...
		float candidateAcronymScore = acronymScoring(name1Info.getOriginalCandidates(), name2Info.getOriginalCandidates());
		float score = 0.0f;
		if (specificCase)
			return acronymScore;
	...
	/**
	 * Finds the possible acronyms of a long string (presumably multiple words) with and
	 * without words like "of, at, the" included in the abbreviated form.
	 * 
	 * @param longName	The longer of two strings being compared
	 * @return	A string representation of the possible acronym(s) that longName could be
	 */
	...
	/**
	 * Returns true if the shorter string is an abbreviation, or a variant of acceptable ones, of the longer string.
	 * 
	 * @param shortName	Shorter of two strings being compared
	 * @param longName	Longer of two strings being compared
	 * @return	A boolean value (true/false) determining whether shortName is a possible acronym of longName
	 */
	...
	/**
	 * More rigorously defined than isAcronymFirstLetters; returns true if the shorter string is
	 * exactly an acronym of the longer string.
	 * 
	 * @param acronym	Shorter of the two strings
	 * @param fullName	Longer of the two strings
	 * @return	A boolean value (true/false) determining whether the acronym is an exactly
	 * acceptable abbreviation for the longer string
	 */
