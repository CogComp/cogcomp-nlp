...
public class Datastore {
	...
	public Datastore() throws DatastoreException {
		// Create a minioClient with the information read from configuration
		// file
	...
	public File getFile(String groupId, String artifactId, Double version, Boolean isPrivate)
	...
	private String getNormalizedArtifactId(String artifactId, Double version) {
		// old way: put the version number between the file name and its
		// extension
		/*
		 * String extension = FilenameUtils.getExtension(artifactId); String
		 * fileNameWithoutExtension = artifactId.replace(extension, "");
		 * fileNameWithoutExtension + "-" + Double.toString(version) +
	...
	/**
	 * Download resource file from cogcom server Simply comment out the file
	 * that you don't want to download Notice: It may take hours to download all
	 * the files
	 * 
	 * @param args
	 * @throws DatastoreException
