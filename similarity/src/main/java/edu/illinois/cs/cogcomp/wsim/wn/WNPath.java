...
public class WNPath {
	...
	public static WNPath getWN(ArrayList<IPointer> ptrs1, ArrayList<IPointer> ptrs2, ISynset synset, String w1, String w2) {
	...
	public static void addPath(	ArrayList<IPointer> pters1, ArrayList<IPointer> pters2, ISynset synset, String w1, String w2) {
