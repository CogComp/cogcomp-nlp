...
public class HonorificManager {
	...
	/**
	 * Constructor to initialize a HonorificManager object, which is used to determine if
	 * a string or a pair of strings should be assigned type PER.
	 * 
	 * @param honorificFileName	File name to obtain list of honorific strings
	 * @throws IOException
	 */
	...
	/**
	 * Reads the file and stores the list of known honorific strings in a HashMap.
	 * 
	 * @throws IOException
	 */
	 ...
	 * 
	 * @param str	String to be tested whether it is an honorific or not
	 * @return	A boolean value (true/false) determining whether the string is an honorific
	 */
	 ...
	 * 
	 * 
	 * @param hono1	First honorific string
	 * @param hono2 Second honorific string
	 * @return	A boolean value (true/false) determining whether the two honorifics are the same with
	 * regards to gender and title
	 */
