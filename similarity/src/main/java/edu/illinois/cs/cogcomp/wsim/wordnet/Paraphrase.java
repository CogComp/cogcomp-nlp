...
public class Paraphrase extends StringMetric< MetricWord > {
	 ...
	 *
	 * @param args optional: config file containing path to the paraphrase resource, as in config/sampleConfig.txt
	 * @throws IOException
	 */
	 ...
	 * Constructor
	 *
	 * @param rm ResourceManager with non-default properties set
	 * @throws IOException
	 */
	...
	private void initialize(String path) {
		...
		for (String s : lines) {
			...
			try {
				...
				// TODO: clean up this pattern. Check for problem explicitly, don't hide exceptions.
				// this happens because some entries are malformed, with nothing between some sets of '@@@' delimiters.
				//e.printStackTrace();
				logger.warn( "Malformed paraphrase entry from '" + path + "': " +
					e.getMessage() );
			}
		}
	}
	...
	/**
	 * Calculates similarity between two words when only word strings are present.
	 * may be asymmetric
	 *
	 * @param small 1st component
	 * @param big 2nd component
	 ...
	 * TODO: determine catalog of POS values for args 2 and 4
	 *
	 * @param arg1 1st word
	 * @param pos1 part-of-speech tag for first word
	 * @param arg2 2nd word
	 * @param pos2 part-of-speech tag for second word
	...
	/**
	 * Calculates similarity between word1 and word2
	 * TODO: determine catalog of POS values for POS tags of word1 and word2
	 *
	 * @param arg1 1st component (word + POS tag)
	 * @param arg2 2nd component
	 * @return similarity score between words plus a "reason"
	 * @throws IllegalArgumentException
	 * @throws NotImplementedException
	 */
	public MetricResponse compare(MetricWord arg1, MetricWord arg2) throws IllegalArgumentException, NotImplementedException {
