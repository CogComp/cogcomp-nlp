...
public class IllinoisTokenizer implements Tokenizer
{
     ...
     * @return an ordered list of tokens from the sentence, and an ordered list of their
     *         start and end character offsets (one-past-the-end indexing)
     */
    @Override
     ...
     * @return  a {@link Tokenization} object containing the ordered token strings, their character offsets,
     *          and sentence end positions (as one-past-the-end token offsets)
     */
