...
public class StatefulTokenizer implements Tokenizer {
    ...
    static public void main(String[] args) {
    	String issue1 = "5 careers: big demand, big pay if you're in one of the jobs listed here, you may be able to negotiate a sweet pay hike for yourself when changing employers. by jeanne sahadi, cnnmoney.com senior writer february 3, 2006: 4:42 pm est \n"+
