...
public class Evaluator {
    ...
    public Evaluator() {
        OntoNotesJsonReader reader =
                new OntoNotesJsonReader("tokenizer/src/test/resources/json_output.txt");
    ...
    public void evaluateIllinoisTokenizer(EvaluationCriteria criteria) {
        ...
        for (String text : rawTexts)
            rawString += text + System.lineSeparator();
    ...
    public void evaluateStanfordTokenizer(EvaluationCriteria criteria) {
        ...
        TextAnnotation stanfordTA =
                Utility.parseIntoTextAnnotation(stanfordTokenizer.getSentences());
        evaluateTokenizer(goldStandardTA, stanfordTA, criteria);
    }

    private void evaluateTokenizer(TextAnnotation goldRecord, TextAnnotation sampleRecord,
