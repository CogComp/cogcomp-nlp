...
public class IllinoisTokenizerTest {
    ...
    public void testIllinoisTokenizer() {
        edu.illinois.cs.cogcomp.nlp.tokenizer.Tokenizer tokenizer = new IllinoisTokenizer();
    ...
    public void testIllinoisTokenizerMultiline() {
        edu.illinois.cs.cogcomp.nlp.tokenizer.Tokenizer tkr = new IllinoisTokenizer();
        String text =
