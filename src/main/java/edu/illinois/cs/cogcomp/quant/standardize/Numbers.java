...
public class Numbers implements Serializable {
	...
	public static String NUMBER, FRACTION, ORDINAL, DECIMAL, ANYNUMBERLIKETHING,
	NEG_DECIMAL;
...
//					System.out.println("Token : "+tokens.get(i)+" Num : "+num);
		...
		for(int i = indexOfLastOrder+1; i < tokens.size(); i++) {
			...
			if(str2num.containsKey(tokens.get(i)) && i < tokens.size()-1 	// three-forths
					&& fractions.containsKey(tokens.get(i+1))
					&& (str2num.get(tokens.get(i))%10 != 0 
					|| str2num.get(tokens.get(i)) < fractions.get(tokens.get(i+1)))) {
...
//			System.out.println("Extract number: "+quantity.value);
	...
	public static void main(String args[]) {
		...
		System.out.println(extractNumber(
				"a hundred and forty and a half dollars"));
		System.out.println(extractNumber(
				"two fifth century"));
		System.out.println(extractNumber(
				"2.3e5"));
