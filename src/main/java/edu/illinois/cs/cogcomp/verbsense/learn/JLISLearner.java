...
public class JLISLearner {
	...
	public static void saveWeightVector(WeightVector weightVector, String modelName) throws IOException {
	...
	public static WeightVector trainStructSVM(
			AbstractInferenceSolver[] inference, StructuredProblem structuredProblem, double c) throws Exception {
	...
	public static LearnerParameters crossvalStructSVMSense(
			StructuredProblem problem, AbstractInferenceSolver[] inference, int nFolds) throws Exception {
	...
	public static double evaluateSenseStructure(
			AbstractInferenceSolver inference, StructuredProblem testSet, WeightVector weights) throws Exception {
