...
namespace SPTransliteration
{
    ...
    internal class CSPModel : TransliterationModel, ICloneable
    {
    ...
    internal struct CSPExampleCounts
    {
        public SparseDoubleVector<Pair<Triple<string, string, string>, string>> productionCounts;
        public SparseDoubleVector<Triple<string, string, string>> segCounts;
    }

    internal static class CSPTransliteration
    {
        ...
        public static CSPModel LearnModel(List<Triple<string, string, double>> examples, CSPModel model)
        {
            ...
            if (model.underflowChecking)
            {
                ...
                foreach (KeyValuePair<Pair<Triple<string, string, string>, string>, double> pair in model.productionProbs)
                ...
                foreach (Pair<Triple<string, string, string>, string> pair in restoreList)
        ...
        public static CSPExampleCounts LearnModel(string word1, string word2, CSPModel model)
        {
            ...
            {
                //Dictionary<Pair<int, string>, Triple<int, string, string>> bestProdProbs = new Dictionary<Pair<int, string>, Triple<int, string, string>>();
                SparseDoubleVector<Pair<int, string>> sumProdProbs = new SparseDoubleVector<Pair<int, string>>();
                foreach (KeyValuePair<Triple<int, string, string>, double> pair in raw.x)
                    sumProdProbs[pair.Key.XY] += pair.Value;

                SparseDoubleVector<Triple<int, string, string>> newCounts = new SparseDoubleVector<Triple<int, string, string>>(raw.x.Count);
                foreach (KeyValuePair<Triple<int, string, string>, double> pair in raw.x)
