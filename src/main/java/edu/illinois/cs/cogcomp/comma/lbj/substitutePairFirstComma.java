...
public class substitutePairFirstComma extends ParameterizedConstraint
{
  ...
  public substitutePairFirstComma() { super("edu.illinois.cs.cogcomp.comma.lbj.substitutePairFirstComma"); }
  ...
  public String discreteValue(Object __example)
  {
    if (!(__example instanceof Sentence))
    {
      ...
      System.err.println("Constraint 'substitutePairFirstComma(Sentence)' defined on line 194 of CommaClassifier.lbj received '" + type + "' as input.");
  ...
  public FeatureVector[] classify(Object[] examples)
  {
    if (!(examples instanceof Sentence[]))
    {
      ...
      System.err.println("Classifier 'substitutePairFirstComma(Sentence)' defined on line 194 of CommaClassifier.lbj received '" + type + "' as input.");
      new Exception().printStackTrace();
      System.exit(1);
    }
  ...
  public int hashCode() { return "substitutePairFirstComma".hashCode(); }
  public boolean equals(Object o) { return o instanceof substitutePairFirstComma; }
