...
{
  private static final RightToLeftDependencies __RightToLeftDependencies = new RightToLeftDependencies();
  private static final LeftToRightDependencies __LeftToRightDependencies = new LeftToRightDependencies();
  ...
  public FeatureVector classify(Object __example)
  {
    if (!(__example instanceof Comma))
    {
      ...
      System.err.println("Classifier 'DependencyFeatures(Comma)' defined on line 176 of CommaClassifier.lbj received '" + type + "' as input.");
  ...
  public int hashCode() { return "DependencyFeatures".hashCode(); }
  public boolean equals(Object o) { return o instanceof DependencyFeatures; }
