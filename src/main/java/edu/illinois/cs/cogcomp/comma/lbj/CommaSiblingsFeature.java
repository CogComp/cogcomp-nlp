...
public class CommaSiblingsFeature extends Classifier
{
  ...
  public String discreteValue(Object __example)
  {
    if (!(__example instanceof Comma))
    {
      ...
      System.err.println("Classifier 'CommaSiblingsFeature(Comma)' defined on line 149 of CommaClassifier.lbj received '" + type + "' as input.");
  ...
  public int hashCode() { return "CommaSiblingsFeature".hashCode(); }
  public boolean equals(Object o) { return o instanceof CommaSiblingsFeature; }
}
