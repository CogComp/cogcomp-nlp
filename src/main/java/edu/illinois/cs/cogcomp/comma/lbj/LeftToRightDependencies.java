...
public class LeftToRightDependencies extends Classifier
{
  ...
  public FeatureVector classify(Object __example)
  {
    if (!(__example instanceof Comma))
    {
      ...
      System.err.println("Classifier 'LeftToRightDependencies(Comma)' defined on line 54 of CommaClassifier.lbj received '" + type + "' as input.");
  ...
  public int hashCode() { return "LeftToRightDependencies".hashCode(); }
  public boolean equals(Object o) { return o instanceof LeftToRightDependencies; }
}
