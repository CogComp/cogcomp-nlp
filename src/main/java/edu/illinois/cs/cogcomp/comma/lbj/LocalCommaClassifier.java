...
public class LocalCommaClassifier extends SparseNetworkLearner
{
  ...
  {
    if (instance == null) instance = new LocalCommaClassifier(true);
  }

  public static Parser getParser() { return new CommaParser(new PrettyCorpusReader(CommaProperties.getInstance().getCommaLabeledDataFile()).getSentences(), CommaParser.Ordering.ORDERED, true); }
  ...
  public LocalCommaClassifier(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }
  ...
  public LocalCommaClassifier(Parameters p, String modelPath, String lexiconPath) {
    ...
    if (modelfile.exists()) {
      ...
      readLexiconOnDemand(IOUtilities.loadFromClasspath(LocalCommaClassifier.class, lexiconPath));
    }
    else {
      containingPackage = "edu.illinois.cs.cogcomp.comma.lbj";
      name = "LocalCommaClassifier";
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof Comma || example instanceof Object[]))
      {
        ...
        System.err.println("Classifier 'LocalCommaClassifier(Comma)' defined on line 186 of CommaClassifier.lbj received '" + type + "' as input.");
  ...
  public int hashCode() { return "LocalCommaClassifier".hashCode(); }
  public boolean equals(Object o) { return o instanceof LocalCommaClassifier; }
  ...
  {
    public Parameters() { super((SparseNetworkLearner.Parameters) new LocalCommaClassifier(false).getParameters()); }
  }
}
