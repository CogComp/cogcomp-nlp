...
public class SemanticRoleLabelerTest extends TestCase {
	...
	public void setUp() throws Exception {
		super.setUp();
		verbSRL = new SemanticRoleLabeler(
				"src/test/resources/srl-config.properties", SRLType.Verb.name());
		nomSRL = new SemanticRoleLabeler(
				"src/test/resources/srl-config.properties", SRLType.Nom.name());
	...
	public void testVerbSRL() throws Exception {
		...
		ta.addView(ViewNames.NER_CONLL, new SpanLabelView(ViewNames.NER_CONLL,
				"test", ta, 1d));
		...
		TokenLabelView view = new TokenLabelView(ViewNames.LEMMA, "test", ta,
				1d);
	...
	public void testNomSRL() throws Exception {
		...
		ta.addView(ViewNames.POS, tlv);
		ta.addView(ViewNames.NER_CONLL, new SpanLabelView(ViewNames.NER, "test", ta,
				1d));
		SpanLabelView chunks = new SpanLabelView(ViewNames.SHALLOW_PARSE,
				"test", ta, 1d);
