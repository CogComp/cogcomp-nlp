...
public class NomSRLManager extends SRLManager {
    ...
    private final static String[] coreArguments = {"A0", "A1", "A2", "A3", "A4", "A5", "A8", "A9"};

    private final static String[] modifierArguments = {"AM-ADV", "AM-CAU", "AM-DIR", "AM-DIS",
            "AM-EXT", "AM-LOC", "AM-MNR", "AM-NEG", "AM-PNC", "AM-PRD", "AM-TMP"};

    private static final String[] allArguments = {NULL_LABEL, "A0", "A1", "A2", "A3", "A4", "A5",
            "A8", "A9", "AM-ADV", "AM-CAU", "AM-DIR", "AM-DIS", "AM-EXT", "AM-LOC", "AM-MNR",
            "AM-NEG", "AM-PNC", "AM-PRD", "AM-TMP", "C-A0", "C-A1", "C-A2", "C-A3", "C-SUP",
            "R-A0", "R-A1", "R-A2", "R-A3", "R-A4", "R-A8", "R-AM-CAU", "R-AM-LOC", "SUP"};
