...
public class BeVerbConstraints extends SRLILPConstraintGenerator {
    ...
    private final static Set<String> validArgs = new HashSet<>(Arrays.asList("A1", "AA", "AM",
            "AM-ADV", "AM-CAU", "AM-DIR", "AM-DIS", "AM-EXT", "AM-LOC", "AM-MNR", "AM-MOD",
            ...
            "V", "C-V", SRLManager.NULL_LABEL, "C-A4", "C-A5", "C-AM-DIR", "C-AM-NEG", "C-AM-PNC",
            "C-AM-TMP", "R-A4", "R-AA", "R-AM-CAU", "R-AM-DIR", "R-AM-EXT"));
    ...
    public List<ILPConstraint> getViolatedILPConstraints(IInstance ins, IStructure s,
        ...
        for (int predicateId = 0; predicateId < x.numPredicates(); predicateId++) {
            ...
            boolean done = false;
            if (predicateToken + 1 < ta.getSentence(predicate.getSentenceId()).getEndSpan()) {
            ...
            for (int candidateId = 0; candidateId < xp.getCandidateInstances().size(); candidateId++) {
                ...
                for (String label : allowedArgs) {
                    ...
                    vars[id] =
                            getArgumentVariable(variables, manager.getPredictedViewName(),
