...
public class LearnerConfigurator extends Configurator {
     ...
     */
    public static final Property L2_LOS_SSVM_SOLVER_TYPE = new Property("L2_LOSS_SSVM_SOLVER_TYPE",
            "ParallelDCDSolver");
    ...
    public ResourceManager getDefaultConfig() {
        Property[] properties =
                {LEARNING_MODEL, L2_LOS_SSVM_SOLVER_TYPE, NUM_THREADS, REGULARIZATION,
                        USE_TRAINMINI, TRAINMINI_SIZE, CHECK_INFERENCE_OPT, MAX_NUM_ITER};
