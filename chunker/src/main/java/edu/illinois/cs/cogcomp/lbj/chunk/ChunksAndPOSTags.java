...
/**
 * This command line program takes a plain, unannotated text file as input
 * and annotates the text with chunk and part of speech tags.  Both the
 * Illinois POS tagger and the Illinois Chunker must be on the
 * <code>CLASSPATH</code> for this command to execute.
 *
 * <h4>Usage</h4>
 * <blockquote><code>
 *   java edu.illinois.cs.cogcomp.lbj.chunk.ChunksAndPOSTags
 *          &lt;input file&gt;
 * </code></blockquote>
 *
 * <h4>Input</h4>
 * The only command line parameter specifies the relative path to a file
 * containing the plain text to be annotated.
 *
 * <h4>Output</h4>
 * The input text with predicted chunk and POS annotations
 * is produced on <code>STDOUT</code>.  Annotated segments will
...
public class ChunksAndPOSTags {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println(
                    "usage: java edu.illinois.cs.cogcomp.lbj.chunk.ChunksAndPOSTags <input file>");
            System.exit(1);
        }
