 ...
 * testing data. The optional second parameter is the name of a <code>LBJ2.parse.Parser</code> whose
 * constructor takes the name of a file as a <code>String</code> as input and that produces
 * <code>LBJ2.parse.LinkedVector</code> objects representing sentences. When omitted, the default is
 * {@link CoNLL2000Parser}.
 *
 * <h4>Output</h4>
 * The output is generated by the <code>LBJ2.classify.TestDiscrete</code> class. See its online
 * documentation at <a
 * href="http://l2r.cs.uiuc.edu/~cogcomp/software/LBJ2/library/LBJ2/classify/TestDiscrete.html">
