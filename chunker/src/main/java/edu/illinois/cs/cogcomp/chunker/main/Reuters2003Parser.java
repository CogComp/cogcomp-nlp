 ...
 * sentences and words that appear in the Reuters 2003 corpora.  It produces
 * <code>LBJ2.parse.LinkedVector</code>s populated by
...
public class Reuters2003Parser extends ColumnFormat {
     ...
     **/
    public Reuters2003Parser(String file) { super(file); }
    ...
    public Object next() {
        ...
        if (line[3].charAt(0) == 'I') line[3] = "B" + line[3].substring(1);
