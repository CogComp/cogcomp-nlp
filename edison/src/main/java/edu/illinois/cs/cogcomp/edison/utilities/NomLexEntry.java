...
public class NomLexEntry {
	public final static Set<NomLexClasses> VERBAL = new LinkedHashSet<>(Arrays.asList(NOM, NOMLIKE, NOMING, ABLE_NOM));

	public final static Set<NomLexClasses> ADJECTIVAL = new LinkedHashSet<>(Arrays.asList(NOMADJ, NOMADJLIKE));

	public final static Set<NomLexClasses> NON_VERB_ADJ = new LinkedHashSet<>(
			Arrays.asList(ABILITY, ATTRIBUTE, CRISSCROSS, ENVIRONMENT, EVENT, FIELD, GROUP, HALLMARK, ISSUE, JOB,
