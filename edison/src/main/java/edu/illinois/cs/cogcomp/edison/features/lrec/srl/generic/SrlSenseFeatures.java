 ...
 * Combines {@link WordFeatureExtractorFactory} word, pos, lemma; {@link ChunkPropertyFeatureFactory} hasModalVerb
 *     and isNegated; {@link NgramFeatureExtractor} word bigrams and trigrams; and transformations
 *     {@link FeatureInputTransformer} stanfordGovernor and stanfordObject applied to
 *     {@link SrlWordFeatures}.
 * @keywords SRL, Nominalization, nominal, nom, predicate, lexical, ngram, bigram, trigram, governor, object
 * @author Xinbo Wu
 */
public class SrlSenseFeatures implements FeatureExtractor {
	...
	public SrlSenseFeatures()throws Exception{
		...
		this.base.addFeatureExtractor(new FeatureCollection("", FeatureInputTransformer.stanfordGovernor, new SrlWordFeatures("")));
		this.base.addFeatureExtractor(new FeatureCollection("", FeatureInputTransformer.stanfordObject, new SrlWordFeatures("")));
	}
