...
class WordNetClasses {
	...
	static {
		...
		wnClasses.put("wn:hypernyms-lexfiles-first-sense", hypernymFirstSenseLexicographerFileNames);
		wnClasses.put("wn:hypernyms-lexfiles-all", hypernymAllSensesLexicographerFileNames);

		wnClasses.put("wn:part-holonyms-lexfiles-first-sense", partHolonymsFirstSenseLexicographerFileNames);
		wnClasses.put("wn:part-holonyms-lexfiles-all", partHolonymsAllSensesLexicographerFileNames);

		wnClasses.put("wn:substance-holonyms-lexfiles-first-sense", substanceHolonymsFirstSenseLexicographerFileNames);
		wnClasses.put("wn:substance-lexfiles-holonyms-all", substanceHolonymsAllSensesLexicographerFileNames);

		wnClasses.put("wn:member-holonyms-lexfiles-first-sense", memberHolonymsFirstSenseLexicographerFileNames);
		wnClasses.put("wn:member-lexfiles-holonyms-all", memberHolonymsAllSensesLexicographerFileNames);
