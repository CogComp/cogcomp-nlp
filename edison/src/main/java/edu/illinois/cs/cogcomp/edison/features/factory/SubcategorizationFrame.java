 ...
 * tree and reports expands its parent. For verb SRL_VERB, for example, the
 * subcategorization frame would be the expansion of the verb's parent in the
 * parse tree. The parse phrase corresponding to the input constituent is marked
 * in the feature.
 *
...
public class SubcategorizationFrame implements FeatureExtractor {
	...
	public static SubcategorizationFrame CHARNIAK = new SubcategorizationFrame(ViewNames.PARSE_CHARNIAK);
	public static SubcategorizationFrame STANFORD = new SubcategorizationFrame(ViewNames.PARSE_STANFORD);
