 ...
 * input constituent. Typically, the input constituent for this feature
 * extractor is a single token.
 *
...
public class TokenPrefixFeatureExtractor implements FeatureExtractor {
	...
	public Set<Feature> getFeatures(Constituent c) throws EdisonException {
		return FeatureUtilities.prefix(c.getTokenizedSurfaceForm().toLowerCase().trim(), base.getFeatures(c));
	}
