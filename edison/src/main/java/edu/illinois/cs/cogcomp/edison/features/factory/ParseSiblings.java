 ...
 * siblings of the input constituent. Uses the specified parse view and the
 * Collins' head percolation rules to find the heads.
 * <p/>
...
public class ParseSiblings implements FeatureExtractor {
	...
	public Set<Feature> getFeatures(Constituent c) throws EdisonException {
		...
		if (phrase.getIncomingRelations().size() == 0) {
			...
			if (position == 0) features.add(DiscreteFeature.create("FIRST_CHILD"));
