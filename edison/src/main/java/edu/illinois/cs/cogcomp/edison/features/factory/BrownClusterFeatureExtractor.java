...
/**
 * A {@code WordFeatureExtractor} that generates prefixes of brown cluster Ids
 * for each word.
 *
...
public class BrownClusterFeatureExtractor extends WordFeatureExtractor {
	...
	public static final BrownClusterFeatureExtractor instance100, instance320, instance1000, instance3200;

	public final static int[] prefixes = new int[]{4, 6, 10, 20};

	static {
		try {
			instance100 = new BrownClusterFeatureExtractor("100", BrownClusterViewGenerator.file100, prefixes);
			instance320 = new BrownClusterFeatureExtractor("320", BrownClusterViewGenerator.file320, prefixes);
			instance1000 = new BrownClusterFeatureExtractor("1000", BrownClusterViewGenerator.file1000, prefixes);
			instance3200 = new BrownClusterFeatureExtractor("3200", BrownClusterViewGenerator.file3200, prefixes);
	...
	public BrownClusterFeatureExtractor(String name, String brownClustersFile, int[] prefixLengths) throws
			EdisonException {
	 ...
	 */
	public BrownClusterFeatureExtractor(String name, String brownClustersFile, int[] prefixLengths, boolean useLastWord) throws
			EdisonException {
		super(useLastWord);
		this.name = name;
	...
	private Set<Feature> getBrownClusters(String word, String cluster) {
		...
		for (int length : prefixLengths) {
			if (cluster.length() >= length) {
				set.add(DiscreteFeature.create("prefix-" + length + ":" + cluster.substring(0, length)));
			}
		}
