...
/**
 * Conjoins {@link NomLexClassFeature} with {@link SrlNomPredicateFeatures}. Sets identifier to indicate it is used for Nominal predicates
 *     (as opposed to verb or other predicates).
 *
...
public class NomLexClassAndSrlNomPredicateFeatures implements FeatureExtractor {
	...
	public NomLexClassAndSrlNomPredicateFeatures(){
		this.base.addFeatureExtractor(FeatureUtilities.conjoin(NomLexClassFeature.instance,new SrlNomPredicateFeatures("")));
	}
