...
class KnownFexes {
	...
	private static final Set<Feature> bias = Collections
			.unmodifiableSet(new LinkedHashSet<Feature>(Collections.singletonList(DiscreteFeature.create("bias"))));
	...
	static {
		...
		fexes.put("gazetteers", WordFeatureExtractorFactory
				.getGazetteerFeatureExtractor("gazetteers", GazetteerViewGenerator.gazetteersInstance));

		fexes.put("cbc", WordFeatureExtractorFactory
				.getGazetteerFeatureExtractor("cbc", GazetteerViewGenerator.gazetteersInstance));
