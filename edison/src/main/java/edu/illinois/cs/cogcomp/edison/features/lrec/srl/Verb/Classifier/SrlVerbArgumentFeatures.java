...
/**
 *
 * @keywords  semantic role labeling, srl, verbal, verb, classifier, argument
 * @author Xinbo Wu
 */
public class SrlVerbArgumentFeatures implements FeatureExtractor {
	...
	public SrlVerbArgumentFeatures(){
		...
		base.addFeatureExtractor(new ParseHeadWordFeatureExtractor(ViewNames.PARSE_STANFORD, new WordAndPos("")));
	}
