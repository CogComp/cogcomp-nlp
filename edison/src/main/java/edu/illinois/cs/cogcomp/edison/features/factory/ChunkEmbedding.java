 ...
 * <li>A thresholded version of the number of chunks. This is a discrete feature
 * with four possible values: 0, 1, 2, many</li>
 * <li>The embedding of the chunks (one of embedded-in, embeds, is,
 * exclusively-overlaps, has-overlap, has-no-overlap, same-start-span,
 * same-end-span). These conditions are checked using the corresponding query in
 * {@link Queries}. This feature also includes the label of the chunk</li>
...
public class ChunkEmbedding implements FeatureExtractor {
	...
	public Set<Feature> getFeatures(Constituent c) throws EdisonException {
		...
		if (numChunks > 0) features.add(RealFeature.create("nchnks", numChunks));
	...
	private void addFeatures(Set<Feature> features, View view, Predicate<Constituent> condition, Counter<String> counter, String name) {
