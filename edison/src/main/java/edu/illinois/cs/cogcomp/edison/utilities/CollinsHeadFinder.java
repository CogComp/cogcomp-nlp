...
public class CollinsHeadFinder extends HeadFinderBase {
	...
	public static final CollinsHeadFinder instance = new CollinsHeadFinder();
	...
	public CollinsHeadFinder() {
		...
		addHeadInformation("ADJP", left,
				new String[]{"NNS", "QP", "NN", "$", "ADVP", "JJ", "VBN", "VBG", "ADJP", "JJR", "NP", "JJS", "DT", "FW",
						"RBR", "RBS", "SBAR", "RB"});

		addHeadInformation("ADVP", right,
				new String[]{"RB", "RBR", "RBS", "FW", "ADVP", "TO", "CD", "JJR", "JJ", "IN", "NP", "JJS", "NN"});
		...
		addHeadInformation("NAC", left,
				new String[]{"NN", "NNS", "NNP", "NNPS", "NP", "NAC", "EX", "$", "CD", "QP", "PRP", "VBG", "JJ", "JJS",
						"JJR", "ADJP", "FW"});
		...
		addHeadInformation("QP", left,
				new String[]{"IN", "NNS", "NN", "JJ", "RB", "DT", "CD", "NCD", "QP", "JJR", "JJS"});
		...
		addHeadInformation("SBAR", left,
				new String[]{"WHNP", "WHPP", "WHADVP", "WHADJP", "IN", "DT", "S", "SQ", "SINV", "SBAR", "FRAG"});

		addHeadInformation("SBARQ", left, new String[]{"left", "SQ", "S", "SINV", "SBARQ", "FRAG"});

		addHeadInformation("SINV", left,
				new String[]{"VBZ", "VBD", "VBP", "VB", "MD", "VP", "S", "SINV", "ADJP", "NP"});

		addHeadInformation("SQ", left, new String[]{"VBZ", "VBD", "VBP", "VB", "MD", "VP", "SQ"});

		addHeadInformation("UCP", right, new String[]{});

		addHeadInformation("VP", left,
				new String[]{"TO", "VBD", "VBN", "MD", "VBZ", "VB", "VBG", "VBP", "AUX", "AUXG", "VP", "ADJP", "NN",
						"NNS", "NP"});
	...
	public List<Pair<HeadSearchDirection, String[]>> getNonterminalHeadInformation(String nonTerminal) {
		if (headFinderInformation.containsKey(nonTerminal)) return headFinderInformation.get(nonTerminal);
		else return null;
	}
	...
	protected int fixHeadChildHacks(int headChildId, Constituent tree) {
		if (headChildId >= 2) {
			...
			if (prev.equals("CC")) {
				...
				while (newHeadIndex >= 0 && ParseTreeProperties.isPreTerminal(child) && POSUtils
						.isPOSPunctuation(child.getLabel())) newHeadIndex--;
				if (newHeadIndex >= 0) headChildId = newHeadIndex;
			}
		}
