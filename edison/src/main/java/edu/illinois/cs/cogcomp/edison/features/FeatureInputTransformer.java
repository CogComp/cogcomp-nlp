...
public abstract class FeatureInputTransformer extends ITransformer<Constituent, List<Constituent>> {
	...
	public static final FeatureInputTransformer easyFirstDependencyModifiers = new FeatureInputTransformer() {
	...
	public static final FeatureInputTransformer stanfordDependencyModifiers = new FeatureInputTransformer() {
	...
	public static final FeatureInputTransformer easyFirstDependencyHead = new FeatureInputTransformer() {
	...
	public static final FeatureInputTransformer stanfordDependencyHead = new FeatureInputTransformer() {
	...
	public static final FeatureInputTransformer easyFirstDependencyGovernor = new FeatureInputTransformer() {
	...
	public static final FeatureInputTransformer stanfordDependencyGovernor = new FeatureInputTransformer() {

		@Override
		public List<Constituent> transform(Constituent input) {

			TreeView dependency = (TreeView) input.getTextAnnotation().getView(ViewNames.DEPENDENCY_STANFORD);
	...
	public static final FeatureInputTransformer easyFirstDependencyObject = new FeatureInputTransformer() {
	...
	public static final FeatureInputTransformer stanfordDependencyObject = new FeatureInputTransformer() {
	...
	public static final FeatureInputTransformer easyFirstNeighboringPP = new FeatureInputTransformer() {
		...
		public List<Constituent> transform(Constituent c) {
			...
			Constituent prepositionDepConstituent = dependency.getConstituentsCoveringToken(tokenPosition).get(0);
	...
	public final static FeatureInputTransformer easyFirstSubjectOfDominatingVerb = new FeatureInputTransformer() {
	...
	public final static FeatureInputTransformer previousWord = new FeatureInputTransformer() {
		...
		public List<Constituent> transform(Constituent input) {
			...
			if (tokenId > 0) {
				Constituent c = new Constituent("", "", input.getTextAnnotation(), tokenId - 1, tokenId);
	...
	public static final FeatureInputTransformer eachWordInConstituent = new FeatureInputTransformer() {
	...
	private static final Annotator CHARNIAK_DEPENDENCIES =
	...
	private static final Annotator STANFORD_DEPENDENCIES =
			new HeadFinderDependencyViewGenerator(ViewNames.PARSE_STANFORD);
	...
	private static final Annotator BERKELEY_DEPENDENCIES =
			new HeadFinderDependencyViewGenerator(ViewNames.PARSE_BERKELEY);
	...
	public static FeatureInputTransformer firstWord = new FeatureInputTransformer() {
		...
		public List<Constituent> transform(Constituent input) {
			return Collections.singletonList(
					new Constituent("", "", input.getTextAnnotation(), input.getStartSpan(), input.getStartSpan() + 1));
		}
	...
	public static FeatureInputTransformer lastWord = new FeatureInputTransformer() {
		...
		public List<Constituent> transform(Constituent input) {
			return Collections.singletonList(
					new Constituent("", "", input.getTextAnnotation(), input.getEndSpan() - 1, input.getEndSpan()));
		}
	...
	private static List<Constituent> getGovernor(Constituent input, TreeView dependency) {
		...
		else return Collections.singletonList(addPointerToSource(input, incomingRelations.get(0).getSource()));
	}
