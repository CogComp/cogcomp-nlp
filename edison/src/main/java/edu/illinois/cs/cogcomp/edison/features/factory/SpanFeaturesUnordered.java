...
public class SpanFeaturesUnordered implements FeatureExtractor {
	...
	public static SpanFeaturesUnordered SHALLOW_PARSE_UNIGRAMS = new SpanFeaturesUnordered(ViewNames.SHALLOW_PARSE, 1);
	public static SpanFeaturesUnordered SHALLOW_PARSE_BIGRAMS = new SpanFeaturesUnordered(ViewNames.SHALLOW_PARSE, 2);
