 ...
 * word of the parent according to the Collins' head percolation rules. The
 * phrase is defined as the smallest node in the parse tree that contains the
 * candidate. If there is more than one such node, the lowest one is chosen.
 * <p/>
 * If possible, use one of the two static objects in this class, for the
 * Charniak and Stanford parses respectively.
 *
...
public class ParsePhraseType implements FeatureExtractor {
	 ...
	 *
	 * @param parseViewname The name of the parse view that supplies the phrases. This
	 *                      view has to be a {@link TreeView}.
	 */
