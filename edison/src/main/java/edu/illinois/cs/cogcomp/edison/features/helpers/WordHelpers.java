...
public class WordHelpers {
	...
	public static List<String> getSynset(TextAnnotation ta, int tokenId, WordNetManager wnManager) throws
			JWNLException {
	...
	public static List<String> getSynsetMostFrequentSense(TextAnnotation ta, int tokenId, WordNetManager wnManager) throws
			JWNLException {
	...
	public static List<String> getHypernyms(TextAnnotation ta, int tokenId, WordNetManager wnManager) throws
			JWNLException {
	...
	public static List<String> getHypernymsMostFrequentSense(TextAnnotation ta, int tokenId, WordNetManager wnManager) throws
			JWNLException {
	...
	private static net.didion.jwnl.data.POS getWNPOS(String pos) {
		if (POSUtils.isPOSNoun(pos)) return net.didion.jwnl.data.POS.NOUN;
		else if (POSUtils.isPOSVerb(pos)) return net.didion.jwnl.data.POS.VERB;
		else if (POSUtils.isPOSAdjective(pos)) return net.didion.jwnl.data.POS.ADJECTIVE;
		else if (POSUtils.isPOSAdverb(pos)) return net.didion.jwnl.data.POS.ADVERB;
		else return null;
	}
}
