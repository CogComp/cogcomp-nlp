...
public class TextStatistics extends ProducerConsumer<TextAnnotation> {
	...
	public TextStatistics(Iterator<TextAnnotation> data, int numThreads, FeatureExtractor fex, ITransformer<TextAnnotation, List<Constituent>> constituentGenerator) {
	...
	protected String getStatus() {
		return "Seen " + textCounter.get() + " TextAnnotations, " + constituentCounter.get() + " constituents";
	}
