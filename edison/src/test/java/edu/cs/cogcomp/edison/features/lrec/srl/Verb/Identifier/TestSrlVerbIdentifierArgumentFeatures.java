 ...
 */
package edu.cs.cogcomp.edison.features.lrec.srl.Verb.Identifier;
...
public class TestSrlVerbIdentifierArgumentFeatures extends TestCase {
    private static Logger logger = LoggerFactory.getLogger(TestSrlVerbIdentifierArgumentFeatures.class);
