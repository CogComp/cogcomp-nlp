...
import edu.cs.cogcomp.edison.features.lrec.srl.Nom.Classifier.SrlNomClassifierPredicateFeatures;
...
/**
 * Standard feature extraction test for {@link SrlNomClassifierPredicateFeatures}
 * 
 * @author Xinbo Wu
 */
public class TestSrlNomClassifierPredicateFeatures extends TestCase {
    private static Logger logger = LoggerFactory.getLogger(TestSrlNomClassifierPredicateFeatures.class);
