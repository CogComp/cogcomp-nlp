...
public class TestWordNetManager extends TestCase {
	...
	public void testGetSynonyms() throws JWNLException {
		...
		assertEquals(Arrays.asList("trial", "trial_run", "test", "tryout", "test", "mental_test", "mental_testing",
				"psychometric_test", "examination", "exam", "test", "test", "trial", "test", "trial", "run", "test",
				"test", "prove", "try", "try_out", "examine", "essay", "screen", "test", "quiz", "test", "test", "test",
				"test", "test"), wordnet.getSynonyms("test", false));
		assertEquals(Arrays.asList("trial", "trial_run", "test", "tryout", "test", "prove", "try", "try_out", "examine",
				"essay"), wordnet.getSynonyms("test", true));
		assertEquals(Arrays.asList("trial", "trial_run", "test", "tryout", "test", "mental_test", "mental_testing",
				"psychometric_test", "examination", "exam", "test", "test", "trial", "test", "trial", "run", "test"),
				wordnet.getSynonyms("test", POS.NOUN, false));
		assertEquals(Arrays.asList("trial", "trial_run", "test", "tryout"),
				wordnet.getSynonyms("test", POS.NOUN, true));

		assertEquals(Arrays.asList("5799212", "1006675", "7197021", "794367", "791078", "1904699", "2531625", "2533109",
				"786458", "2745713", "1112584", "920778", "669970"), wordnet.getSynsets("test", false));
		...
		assertEquals(Collections.singletonList("5799212"), wordnet.getSynsets("test", POS.NOUN, true));
	...
	public void testGetHolonyms() throws JWNLException {
		...
		System.out.println(wordnet.getRelatedWords("bread", POS.NOUN, PointerType.PART_HOLONYM, false));
		System.out.println(wordnet.getRelatedWords("bread", POS.NOUN, PointerType.PART_HOLONYM, true));
		...
		System.out.println(wordnet.getRelatedWords("dog", POS.NOUN, PointerType.MEMBER_HOLONYM, false));
		System.out.println(wordnet.getRelatedWords("dog", POS.NOUN, PointerType.MEMBER_HOLONYM, true));
		...
		System.out.println(wordnet.getRelatedWords("water", POS.NOUN, PointerType.SUBSTANCE_HOLONYM, false));
		System.out.println(wordnet.getRelatedWords("water", POS.NOUN, PointerType.SUBSTANCE_HOLONYM, true));
