...
public class TestParseSibling extends TestCase {
	...
	static {
		try {
			tas = IOUtils.readObjectAsResource(edu.illinois.cs.cogcomp.edison.features.lrec.srl.Verb.Classifier.ParseSibling.class, "test.ta");
		} catch (Exception e) {
...
//		}
		...
		edu.illinois.cs.cogcomp.edison.features.lrec.srl.Verb.Classifier.ParseSibling pf = new ParseSibling();
