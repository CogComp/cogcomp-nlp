 ...
 * @author Xinbo Wu
 */
public class TestSrlVerbSimplePredicateFeatures extends TestCase {
    private static Logger logger = LoggerFactory.getLogger(TestSrlVerbSimplePredicateFeatures.class);
    ...
    public final void test() throws Exception {
        ...
        SrlVerbSimplePredicateFeatures pf = new SrlVerbSimplePredicateFeatures();
