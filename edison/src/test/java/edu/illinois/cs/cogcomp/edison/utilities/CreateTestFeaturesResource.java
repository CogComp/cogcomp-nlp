...
/**
 * Prepares the word.features.test and feature.collection.text files used for the Maven Tests
 * NB: File test.ta needs to exist (see {@link CreateTestTAResource}
 *
 * @author Christos Christodoulopoulos
 */
public class CreateTestFeaturesResource {
	public static final String FEATURE_COLLECTION_FILE = "src/test/resources/feature.collection.test";
