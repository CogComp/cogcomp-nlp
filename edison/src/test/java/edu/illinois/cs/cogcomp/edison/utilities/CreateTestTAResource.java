...
public class CreateTestTAResource {
	...
	private void populateTestInputs() {
		...
		testInputs.add("My mother-in-law, " + "the Queen of Egypt, " + "left me some pearls in October.");

		testInputs.add("I give John $900 today.");
		testInputs.add("This is a test." + " This is another one. " + "My mother-in-law has arrived. ");

		testInputs
				.add("It is a technique widely used in " + "natural language processing." + " It is similar to the concept of " + "lexical analysis for computer languages.");

		testInputs.add("Models of this kind have recently " + "attracted much attention within the NLP community.");

		testInputs.add("  We have three kinds of pastries. " + "One of them has chocolate and the other 2 don't. ");

		testInputs
				.add("Most customers think that our pastries" + " are the best in the world. Some come here " + "from hundreds of miles away.");

		testInputs.add("Three people want more.");
		testInputs.add("This\tsentence has a tab. This does not.");

		testInputs
				.add("By winning the National Football League (NFL) playoff game, " + "the 49ers will host the winner of Sunday's Dallas-Green Bay " + "game on January 15 to decide a berth in the January 29 championship " + "game at Miami.");
		...
		text =
				"It wasn't a long walk to Lisa Cochran's car " + "in the Costco parking lot from the store." + " But by the time she got there, her infant " + "was near death. Cochran blames the Infantino " + "baby sling -- now recalled -- for her baby's death.";
		testInputs.add(text);
		...
		text = "but - (( but I 'd love to have his hair)) something just came off the ~ TV about the Scott trial. ";
		testInputs.add(text);

		text = "Joseph Conrad Parkhurst , who founded the motorcycle magazine Cycle 	World in 1962 , has died.";
		testInputs.add(text);
		...
		text =
				"Steelers Quarterback Jim Brady sneaked a backward pass to running back Joe Corduroy for a last-second " + "denial of Florida that will surely echo down the ages. " + "His first completion of the 2011 season, this pass represents the pinnacle of " + "Jim's terrible season to date, and " + "it may mean redemption of his $13M contract with Pittsburgh, according to Joe's mother.";
		testInputs.add(text);
