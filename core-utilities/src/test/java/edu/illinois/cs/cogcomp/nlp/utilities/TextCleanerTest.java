...
public class TextCleanerTest {
    ...
    public void testCleanText() {
        String badText = "The Turkish Parliament will vote Wednesday on whether to extend a mandate permitting military action against Kurdish " +
    ...
    public void testCleanText2() {
        String badText = "Do you really think we have a different kind of muslim in American .\n" +
    ...
    public void replaceMisusedApostropheSymbol() {
        String badText = "Someone\"s string used a weird apostrophe that ended up as a quotation mark.";
    ...
    public void replaceUnderscores() {
        String badText = "I think _ on balance _ that people should use dashes. ___________ Never use underscores to separate text.";
    ...
    public void replaceTildes() {
        String badText = "Some people use tildes to separate things. ~ I hate it. ~~~ it messes up NLP.";
    ...
    public void replaceDuplicatePunctuation() {
        String badText = "My father,, the duplicate, has three sons!!! and he never -- that is, never!!! --- uses ellipses.... So THere??";
