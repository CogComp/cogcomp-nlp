...
public class PredicateArgumentEvaluatorTest {
    ...
    public void setUp() throws Exception {
        ...
        TextAnnotation taGold = DummyTextAnnotationGenerator.generateAnnotatedTextAnnotation(viewsToAdd);
        TextAnnotation taPred = DummyTextAnnotationGenerator.generateAnnotatedTextAnnotation(viewsToAdd);
    ...
    public void testEvaluateSense() throws Exception {
        PredicateArgumentEvaluator evaluator = new PredicateArgumentEvaluator(gold, predicted);
        ...
        evaluator = new PredicateArgumentEvaluator(gold, predicted);
        evaluator.evaluateSense(senseTester);
