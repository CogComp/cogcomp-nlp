...
/**
 * This class represents a <it>view</it> of the text. According to the
 * multi-view architecture, any annotation on text can be thought of as a graph,
 * where each node in the graph may correspond to sets of tokens in the text.
 * Labeled directed edges between the nodes denote relations.
 * <p/>
 * The nodes are objects of type {@link Constituent} and the edges are objects
 * of type {@link Relation}.
 * <p/>
 * <p/>
 * This class represents a generic <it>view</it> without any restrictions on the
 * structure of the graph and can be used for general purpose application
 * specific views. However, for most standard annotations can be represented as
 * one of the sub-classes of this class.
 *
...
public class View implements Serializable, IQueryable<Constituent> {
    ...
    /**
     * The name of this view. While this can be any arbitrary string, if the
     * view represents a standard annotation, use one of the standard names from
     ...
     * that token.
     * <p/>
     * The first element corresponds to the token id, the second corresponds to
     * the constituent .
     */
     ...
     * using a view generator called {@code ViewGenerator} and is assigned a
     * score {@code score}
     *
     ...
     */
    public View(String viewName, String viewGenerator, TextAnnotation text,
                double score) {
    ...
    private void addRelatedConstituents(View restriction,
                                        Queue<Constituent> constituentsToConsider) {
    ...
    /**
     * This function is used by the filtering code. It adds all constituents
     * that point to the constituents in the parameter childrenToConsider and
     * does this recursively.
     */
    private void addRelatedNullConstituents(Set<Constituent> output, Queue<Constituent> childrenToConsider) {
    ...
    /**
     * Adds a new relation to this view. This function throws an exception if
     * the relation involves constituents that are not contained in this view.
     * In order for a relation to be added, the constituents should have been
     * added first. This function does not check for this.
     *
    ...
    /**
     * This function creates a restriction of this view. That is, it creates a
     * new view of the same type as this view. This function does not add any
     * constituents. That is done by {@code View#getRestrictedView(Predicate,
     * ITransformer)}.
     */
    private View createRestrictedView(ITransformer<View, Double> scoreTransformer) {
        View restriction = null;

        Object[] args = {viewName, viewGenerator, textAnnotation,
                scoreTransformer.transform(this)};
        @SuppressWarnings("rawtypes")
     ...
     *
     * @param c A constituent, not necessarily of this text annotation.
     * @return A list of labels of constituents, which cover the same tokens as
     * the input
     */
    ...
    /**
     * @return The name of this view. While this can be any arbitrary string, if
     * the view represents a standard annotation, it is best to use one
     * of the standard names from {@link edu.illinois.cs.cogcomp.core.datastructures.ViewNames}.
     */
