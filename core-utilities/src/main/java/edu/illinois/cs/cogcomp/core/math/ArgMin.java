 ...
 * <p/>
 * K: type of value over which the max decision is made. T: type of the objects
 ...
 * <b>Example:</b>
 * <p/>
 * Suppose we have a list of strings that can be scored and we wish to track the
 * maximum.
 * <p/>
 * <pre>
