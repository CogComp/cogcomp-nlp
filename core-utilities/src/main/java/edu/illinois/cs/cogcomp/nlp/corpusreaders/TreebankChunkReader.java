...
/**
 * Read the WSJ chunk data reader, generated by the file chunlink.pl in the
 * directory treebank-2 in the standard Penn Treebank distribution. This file
 * reads the data generated by running the following command on each file in
 * {@literal combined/wsj/$dir/$file}:
 * <p/>
 * <p/>
 * <pre>
 ...
 * <p/>
 * <p/>
 * This class takes the standard penn treebank annotation and adds this
 * annotation to it
 * <p/>
...
public class TreebankChunkReader extends PennTreebankReader {
    ...
    public TreebankChunkReader(String treebankHome, String[] sections)
            throws Exception {
    ...
    public TextAnnotation next() {
        ...
        if (chunkLines == null || currentChunkLineId == chunkLines.size()) {
            try {
                chunkLines = LineIO.read(chunkHome + "/"
        ...
        while (currentChunkLineId < chunkLines.size()) {
            ...
            if (line.startsWith("#")) {
                ...
                if (!currentSectionFiles[currentFileId - 1].equals("wsj_" + fId + ".mrg"))
                    throw new IllegalStateException(
                            currentSectionFiles[currentFileId - 1] + " does not match " + "wsj_" + fId + ".mrg");
            ...
            if (currentChunkLabel.equals("")) {
                if (chunkLabel.startsWith("B")) {
                    ...
                    throw new IllegalStateException("Expected B, found "
                            + chunkLabel);
                }
