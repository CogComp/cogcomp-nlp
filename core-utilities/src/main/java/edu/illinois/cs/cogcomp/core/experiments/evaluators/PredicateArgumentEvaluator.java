...
/**
 * Evaluator for the {@link PredicateArgumentView}. Compares two views and returns the results
 * using two {@link ClassificationTester}s: one for the sense of the predicate
 *
...
public class PredicateArgumentEvaluator extends Evaluator {
	 ...
	 * of C-Args in the original script is non-intuitive, but has been replicated here.
     *
