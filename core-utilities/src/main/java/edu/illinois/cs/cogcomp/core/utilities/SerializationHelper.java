...
public class SerializationHelper {
  ...
  /**
   * Serialize a text annotation into a json string. This can be useful for
  ...
  /**
   * Read a text annotation from a json string. The input string must be one
   * that is generated by the
   * {@link SerializationHelper#serializeToJson(TextAnnotation)}
   * function
   *
   * @param jsonString
   *            The json string representation for the text
   * @return A text annotation
   * @throws Exception
   */
  public static TextAnnotation deserializeFromJson(String jsonString)
      throws Exception {
