...
/**
  ...
  * @author Nick Rizzolo
 **/
public class ReadingComprehensionCandidateGenerator extends SparseNetworkLearner
{
  private static void loadInstance()
  {
    if (instance == null) instance = new ReadingComprehensionCandidateGenerator(true);
  }
  ...
  public static ReadingComprehensionCandidateGenerator instance;

  public static ReadingComprehensionCandidateGenerator getInstance()
  {
    loadInstance();
    return instance;
  }

  private ReadingComprehensionCandidateGenerator(boolean b)
  {
    super(new Parameters());
    containingPackage = "edu.illinois.cs.cogcomp.chunker.main.lbjava";
    name = "ReadingComprehensionCandidateGenerator";
    setEncoding(null);
    setLabeler(new ChunkLabel());
    setExtractor(new ReadingComprehensionCandidateGenerator$$1());
    isClone = false;
  }
  ...
  public ReadingComprehensionCandidateGenerator()
  {
    super("edu.illinois.cs.cogcomp.chunker.main.lbjava.ReadingComprehensionCandidateGenerator");
    isClone = true;
  }

  public ReadingComprehensionCandidateGenerator(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }

  public ReadingComprehensionCandidateGenerator(Parameters p, String modelPath, String lexiconPath) {
    super(p);
    try {
    ...
    else if (IOUtilities.existsInClasspath(ReadingComprehensionCandidateGenerator.class, modelPath)) {
      System.out.println("Model file "+modelfile.getAbsolutePath()+" located in a jar file");
      readModel(IOUtilities.loadFromClasspath(ReadingComprehensionCandidateGenerator.class, modelPath));
      readLexiconOnDemand(IOUtilities.loadFromClasspath(ReadingComprehensionCandidateGenerator.class, lexiconPath));
    }
    else {
      containingPackage = "edu.illinois.cs.cogcomp.chunker.main.lbjava";
      name = "ReadingComprehensionCandidateGenerator";
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof Token || example instanceof Object[]))
      {
        ...
        System.err.println("Classifier 'ReadingComprehensionCandidateGenerator(Token)' defined on line 169 of ReadingComprehensionCandidateGenerator.lbj received '" + type + "' as input.");
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: edu.illinois.cs.cogcomp.chunker.main.lbjava.ReadingComprehensionCandidateGenerator \\");
    ...
    ReadingComprehensionCandidateGenerator classifier = new ReadingComprehensionCandidateGenerator();
  ...
  public int hashCode() { return "ReadingComprehensionCandidateGenerator".hashCode(); }
  public boolean equals(Object o) { return o instanceof ReadingComprehensionCandidateGenerator; }
