...
public class BayraktarLabelFeature extends Classifier {
    ...
    public String discreteValue(Object __example) {
        if (!(__example instanceof Comma)) {
            ...
            System.err
                    .println("Classifier 'BayraktarLabelFeature(Comma)' defined on line 173 of CommaClassifier.lbj received '"
                            + type + "' as input.");
    ...
    public int hashCode() {
        return "BayraktarLabelFeature".hashCode();
    }

    public boolean equals(Object o) {
        return o instanceof BayraktarLabelFeature;
    }
}
