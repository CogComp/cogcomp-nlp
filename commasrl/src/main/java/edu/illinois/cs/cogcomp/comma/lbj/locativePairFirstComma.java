...
public class locativePairFirstComma extends ParameterizedConstraint
{
  ...
  public locativePairFirstComma() { super("edu.illinois.cs.cogcomp.comma.lbj.locativePairFirstComma"); }
  ...
  public String discreteValue(Object __example)
  {
    if (!(__example instanceof Sentence))
    {
      ...
      System.err.println("Constraint 'locativePairFirstComma(Sentence)' defined on line 214 of CommaClassifier.lbj received '" + type + "' as input.");
  ...
  public FeatureVector[] classify(Object[] examples)
  {
    if (!(examples instanceof Sentence[]))
    {
      ...
      System.err.println("Classifier 'locativePairFirstComma(Sentence)' defined on line 214 of CommaClassifier.lbj received '" + type + "' as input.");
      new Exception().printStackTrace();
      System.exit(1);
    }
  ...
  public int hashCode() { return "locativePairFirstComma".hashCode(); }
  public boolean equals(Object o) { return o instanceof locativePairFirstComma; }
