...
public class ChunkFeatures extends Classifier
{
  ...
  public FeatureVector classify(Object __example)
  {
    if (!(__example instanceof Comma))
    {
      ...
      System.err.println("Classifier 'ChunkFeatures(Comma)' defined on line 33 of CommaClassifier.lbj received '" + type + "' as input.");
  ...
  public int hashCode() { return "ChunkFeatures".hashCode(); }
  public boolean equals(Object o) { return o instanceof ChunkFeatures; }
}
