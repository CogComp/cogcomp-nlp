...
public class ListCommasConstrainedInference$subjectto extends ParameterizedConstraint {
    ...
    public String discreteValue(Object __example) {
        if (!(__example instanceof Sentence)) {
            ...
            System.err
                    .println("Constraint 'ListCommasConstrainedInference$subjectto(Sentence)' defined on line 280 of CommaClassifier.lbj received '"
                            + type + "' as input.");
    ...
    public FeatureVector[] classify(Object[] examples) {
        if (!(examples instanceof Sentence[])) {
            ...
            System.err
                    .println("Classifier 'ListCommasConstrainedInference$subjectto(Sentence)' defined on line 280 of CommaClassifier.lbj received '"
                            + type + "' as input.");
            new Exception().printStackTrace();
            System.exit(1);
        }
