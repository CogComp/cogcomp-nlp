...
public class LocalCommaClassifier$$1 extends Classifier
{
  ...
  private static final BayraktarLabelFeature __BayraktarLabelFeature = new BayraktarLabelFeature();
  ...
  public FeatureVector classify(Object __example)
  {
    if (!(__example instanceof Comma))
    {
      ...
      System.err.println("Classifier 'LocalCommaClassifier$$1(Comma)' defined on line 187 of CommaClassifier.lbj received '" + type + "' as input.");
  ...
  public int hashCode() { return "LocalCommaClassifier$$1".hashCode(); }
  public boolean equals(Object o) { return o instanceof LocalCommaClassifier$$1; }
