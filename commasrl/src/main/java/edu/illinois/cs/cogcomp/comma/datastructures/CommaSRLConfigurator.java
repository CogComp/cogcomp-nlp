...
public class CommaSRLConfigurator extends Configurator {
    ...
    public static final Property allowMultiLabelCommas = new Property("ALLOW_MULTI_LABEL_COMMAS", Configurator.FALSE);
    ...
    public static final Property includeNullLabelCommas = new Property("INCLUDE_NULL_LABEL_COMMAS", Configurator.FALSE);

    public static final Property getBayraktarAnnotationsDir = new Property("getBayraktarAnnotationsDir", Configurator.FALSE);

    // Locations of Penn Treebank, PropBank and NomBank; used if USE_GOLD is true to get the gold parses and SRLs
    public static final Property getPTBHDir = new Property("PTB_DIR", "/shared/corpora/corporaWeb/treebanks/eng/pennTreebank/treebank-3/parsed/mrg/wsj");
    public static final Property getPropbankDir = new Property("PROPBANK_DIR", "/shared/corpora/corporaWeb/treebanks/eng/propbank_1/data");
    public static final Property getNombankDir = new Property("NOMBANK_DIR", "/shared/corpora/corporaWeb/treebanks/eng/nombank");
    ...
    public static final Property isCommaStructureFullSentence = new Property("IS_COMMA_STRUCTURE_FULL_SENTENCE", Configurator.FALSE);

    // Whether to read the data from data-store, or the local data folder
    public static final Property useDatastoreToReadData = new Property("READ_DATA_FROM_DATASTORE", Configurator.TRUE);

    @Override
    public ResourceManager getDefaultConfig() {
        Property[] props = {useGold, allowMultiLabelCommas, includeNullLabelCommas, isCommaStructureFullSentence,
                getBayraktarAnnotationsDir, getPTBHDir, getPropbankDir, getNombankDir, lexicaliseNER, lexicalisePOS,
                useCurator, dataLocation, useDatastoreToReadData };
