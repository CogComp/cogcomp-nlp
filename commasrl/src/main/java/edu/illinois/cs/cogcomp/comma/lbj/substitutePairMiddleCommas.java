...
public class substitutePairMiddleCommas extends ParameterizedConstraint
{
  ...
  public substitutePairMiddleCommas() { super("edu.illinois.cs.cogcomp.comma.lbj.substitutePairMiddleCommas"); }
  ...
  public String discreteValue(Object __example)
  {
    if (!(__example instanceof Sentence))
    {
      ...
      System.err.println("Constraint 'substitutePairMiddleCommas(Sentence)' defined on line 200 of CommaClassifier.lbj received '" + type + "' as input.");
  ...
  public FeatureVector[] classify(Object[] examples)
  {
    if (!(examples instanceof Sentence[]))
    {
      ...
      System.err.println("Classifier 'substitutePairMiddleCommas(Sentence)' defined on line 200 of CommaClassifier.lbj received '" + type + "' as input.");
      new Exception().printStackTrace();
      System.exit(1);
    }
  ...
  public int hashCode() { return "substitutePairMiddleCommas".hashCode(); }
  public boolean equals(Object o) { return o instanceof substitutePairMiddleCommas; }
