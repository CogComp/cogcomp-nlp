...
public class oxfordComma extends ParameterizedConstraint
{
  ...
  public oxfordComma() { super("edu.illinois.cs.cogcomp.comma.lbj.oxfordComma"); }
  ...
  public String discreteValue(Object __example)
  {
    if (!(__example instanceof Sentence))
    {
      ...
      System.err.println("Constraint 'oxfordComma(Sentence)' defined on line 236 of CommaClassifier.lbj received '" + type + "' as input.");
  ...
  public FeatureVector[] classify(Object[] examples)
  {
    if (!(examples instanceof Sentence[]))
    {
      ...
      System.err.println("Classifier 'oxfordComma(Sentence)' defined on line 236 of CommaClassifier.lbj received '" + type + "' as input.");
      new Exception().printStackTrace();
      System.exit(1);
    }
  ...
  public int hashCode() { return "oxfordComma".hashCode(); }
  public boolean equals(Object o) { return o instanceof oxfordComma; }
