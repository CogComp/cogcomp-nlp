...
public class OxfordCommaConstrainedInference$subjectto extends ParameterizedConstraint
{
  ...
  public OxfordCommaConstrainedInference$subjectto() { super("edu.illinois.cs.cogcomp.comma.lbj.OxfordCommaConstrainedInference$subjectto"); }
  ...
  public String discreteValue(Object __example)
  {
    if (!(__example instanceof Sentence))
    {
      ...
      System.err.println("Constraint 'OxfordCommaConstrainedInference$subjectto(Sentence)' defined on line 256 of CommaClassifier.lbj received '" + type + "' as input.");
  ...
  public FeatureVector[] classify(Object[] examples)
  {
    if (!(examples instanceof Sentence[]))
    {
      ...
      System.err.println("Classifier 'OxfordCommaConstrainedInference$subjectto(Sentence)' defined on line 256 of CommaClassifier.lbj received '" + type + "' as input.");
      new Exception().printStackTrace();
      System.exit(1);
    }
  ...
  public int hashCode() { return "OxfordCommaConstrainedInference$subjectto".hashCode(); }
  public boolean equals(Object o) { return o instanceof OxfordCommaConstrainedInference$subjectto; }
