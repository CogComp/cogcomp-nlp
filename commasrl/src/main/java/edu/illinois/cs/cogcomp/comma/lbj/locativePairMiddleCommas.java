...
public class locativePairMiddleCommas extends ParameterizedConstraint {
    ...
    public String discreteValue(Object __example) {
        if (!(__example instanceof Sentence)) {
            ...
            System.err
                    .println("Constraint 'locativePairMiddleCommas(Sentence)' defined on line 220 of CommaClassifier.lbj received '"
                            + type + "' as input.");
    ...
    public FeatureVector[] classify(Object[] examples) {
        if (!(examples instanceof Sentence[])) {
            ...
            System.err
                    .println("Classifier 'locativePairMiddleCommas(Sentence)' defined on line 220 of CommaClassifier.lbj received '"
                            + type + "' as input.");
            new Exception().printStackTrace();
            System.exit(1);
        }
