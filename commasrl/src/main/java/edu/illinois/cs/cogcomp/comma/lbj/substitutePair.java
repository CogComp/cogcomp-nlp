...
{
  private static final substitutePairFirstComma __substitutePairFirstComma = new substitutePairFirstComma();
  private static final substitutePairMiddleCommas __substitutePairMiddleCommas = new substitutePairMiddleCommas();

  public substitutePair() { super("edu.illinois.cs.cogcomp.comma.lbj.substitutePair"); }
  ...
  public String discreteValue(Object __example)
  {
    if (!(__example instanceof Sentence))
    {
      ...
      System.err.println("Constraint 'substitutePair(Sentence)' defined on line 209 of CommaClassifier.lbj received '" + type + "' as input.");
  ...
  public FeatureVector[] classify(Object[] examples)
  {
    if (!(examples instanceof Sentence[]))
    {
      ...
      System.err.println("Classifier 'substitutePair(Sentence)' defined on line 209 of CommaClassifier.lbj received '" + type + "' as input.");
      new Exception().printStackTrace();
      System.exit(1);
    }
  ...
  public int hashCode() { return "substitutePair".hashCode(); }
  public boolean equals(Object o) { return o instanceof substitutePair; }
