...
public class SparseVector<T extends Serializable> implements Serializable {
	...
	public static<K extends Serializable> SparseVector<K> getOrderedSparseVector (SparseVector<K> vector, 
			Comparator<Map.Entry<K, Double>> c, int topK) {
		
		SparseVector<K> sparseVector = new SparseVector<K>();
		
		List<Map.Entry<K, Double>> entries = new LinkedList<Map.Entry<K, Double>>(vector.keyValueMap.entrySet());
	...
	public static<K extends Serializable> SparseVector<K> getOrderedSparseVector (SparseVector<K> vector, 
			Comparator<Map.Entry<K, Double>> c) {
	...
	public boolean equals (Object o) {
		...
		if ((o instanceof SparseVector<?>) == false)
			return false;
		...
		for (T key : keyValueMap.keySet()) {
			if (thatMap.containsKey(key) == false)
				return false;
