...
public class SparseVectorOperations {
	...
	public static <T> double getNorm (Map<T, Double> vector, Map<T, Double> weights) {
		...
		for (T key : vector.keySet()) {
			...
			if (weights.containsKey(key) == true)
	...
	public static <T> Map<T, Double> addMultipleMaps (List<Map<T, Double>> vectorList) {
		Map<T, Double> finalVector = new HashMap<T, Double>();
		
		for (int i = 0; i < vectorList.size(); i++) {
			finalVector = add(finalVector, vectorList.get(i), 1, 1);
		}
		
		return finalVector;
	}
	
	public static <T> Map<T, Double> add (Map<T, Double> v1, Map<T, Double> v2, double weight1, double weight2) {
		Map<T, Double> sum = new HashMap<T, Double>(v1.size());
	...
	public static <T> Map<T, Double> addMultipleMaps (List<Map<T, Double>> vectorList, List<Double> scoreList) {
		Map<T, Double> finalVector = new HashMap<T, Double>();
	...
	public static <T extends Serializable> SparseVector<T> add (SparseVector<T> v1, SparseVector<T> v2) {
	...
	public static <T extends Serializable> SparseVector<T> addMultipleVectors (List<SparseVector<T>> vectorList) {
		List<Map<T, Double>> maps = new ArrayList<Map<T, Double>>(vectorList.size());
	...
	public static <T extends Serializable> SparseVector<T> averageMultipleVectors (List<SparseVector<T>> vectorList) {
	...
	public static <T extends Serializable> SparseVector<T> add (SparseVector<T> v1, SparseVector<T> v2, double weight1, double weight2) {
	...
	public static <T extends Serializable> SparseVector<T> addMultipleVectors (List<SparseVector<T>> vectorList, List<Double> weightList) {
		List<Map<T, Double>> maps = new ArrayList<Map<T, Double>>(vectorList.size());
	...
	public static <T extends Serializable> SparseVector<T> averageMultipleVectors (List<SparseVector<T>> vectorList, List<Double> weightList) {
	...
	public static <T extends Serializable> SparseVector<T> add (SparseVector<T> v1, SparseVector<T> v2, Map<T, Double> weights) {
		Map<T, Double> sum = add(v1.getKeyValueMap(), v2.getKeyValueMap());
	...
	public static <T> double cosine (Map<T, Double> vector1, Map<T, Double> vector2, Map<T, Double> weights) {
	...
	public static <T> double cosine (Map<T, Double> vector1, Map<T, Double> vector2, double norm1, double norm2) {
		Map<T, Double> weights = new HashMap<T, Double>();
		
		return cosine(vector1, vector2, norm1, norm2, weights);
	}
	
	public static <T> double cosine (Map<T, Double> vector1, Map<T, Double> vector2, double norm1, double norm2, Map<T, Double> weights) {
		if (weights == null) {
			weights = new HashMap<T, Double>();
		}
	...
	public static <T extends Serializable> double cosine (SparseVector<T> vector1, SparseVector<T> vector2, double norm1, double norm2) {
		return cosine(vector1.getKeyValueMap(), vector2.getKeyValueMap(), norm1, norm2);
	}
	
	public static <T extends Serializable> double cosine (SparseVector<T> v1, SparseVector<T> v2, Map<T, Double> weights) {
		return cosine(v1.getKeyValueMap(), v2.getKeyValueMap(), weights);
	}
	
	public static <T extends Serializable> double cosine (SparseVector<T> vector1, SparseVector<T> vector2, double norm1, double norm2, Map<T, Double> weights) {
		return cosine(vector1.getKeyValueMap(), vector2.getKeyValueMap(), norm1, norm2, weights);
	}
	
	public static <T> double jaccard (Map<T, Double> vector1, Map<T, Double> vector2) {
	...
	public static <T extends Serializable> double jaccard (SparseVector<T> v1, SparseVector<T> v2) {
    ...
    public static <T> double SkewDivergence (Map<T, Double> vector1, Map<T, Double> vector2, double gamma) {
        double result = 0.0;
    ...
    public static <T extends Serializable> double SkewDivergence (SparseVector<T> vector1, SparseVector<T> vector2, double gamma) {
    	return SkewDivergence(vector1.getKeyValueMap(), vector2.getKeyValueMap(), gamma);
    }
    
    //TODO: Check this function
    public static <T> double JensenShannon (Map<T, Double> vector1, Map<T, Double> vector2) {
        double result = 0.0;
...
//        result = (Double.MIN_VALUE + (KLDivergence(vector2, middleVector)) / 2);
    ...
    public static <T extends Serializable> double JensenShannon (SparseVector<T> vector1, SparseVector<T> vector2) {
    	return JensenShannon(vector1.getKeyValueMap(), vector2.getKeyValueMap());
    }

    //TODO: Check this function
    public static <T> double KLDivergence (Map<T, Double> vector1, Map<T, Double> vector2) {
        double result = 0.0;
...
//				}
    ...
    public static <T extends Serializable> double KLDivergence (SparseVector<T> vector1, SparseVector<T> vector2) {
