...
/**
 * A Basic Tree implementation that satisfies project specific needs by wrapping around {@link UnorderedTree}
 *   
 * @author shashank
 */
...
public class SimpleTree<N extends Serializable> implements Serializable {
    ...
    /**
     * Returns a set of node's children.
     * If the node has no children then an empty set will be returned.
     */
    ...
    /**
     * @return the depth of the node in this tree, or -1 if the node is
    ...
    /**
     * Initializes the tree with the given node. Can only be invoked once i.e. once the root is set, invoking this will throw an exception.
     * 
    ...
    /**
     * Returns <code>true</code> if <code>node</code> is a leaf of this tree,
     ...
     * this method still returns <code>true</code>.
     */
	...
	public Set<N> getSiblingsInclusive (N node) {
		if (_tree.containsVertex(node) == false)
			return null;
	...
	public boolean equals (Object o) {
		if ((o instanceof SimpleTree<?>) == false)
			return false;
		...
		if (this._tree.equals(that._tree) == false)
			return false;
...
//		out.writeObject(_tree);
//		out.writeObject(addedEdgeCnt);
//	}
//		     
//	@SuppressWarnings("unchecked")
//	private void readObject (ObjectInputStream in) throws IOException, ClassNotFoundException {
//		 _tree = (UnorderedTree<N, Integer>) in.readObject();
//		 addedEdgeCnt = in.readInt();
//	}
