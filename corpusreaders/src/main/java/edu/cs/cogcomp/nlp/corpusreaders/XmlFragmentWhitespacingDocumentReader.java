...
public class XmlFragmentWhitespacingDocumentReader extends AbstractIncrementalCorpusReader {
     ...
     *
     * Base implementation assumes a single Path in each corpusFileListEntry, corresponding to a file with source
     *     text plus any needed annotations.  It also assumes that the file has no markup.
     *
