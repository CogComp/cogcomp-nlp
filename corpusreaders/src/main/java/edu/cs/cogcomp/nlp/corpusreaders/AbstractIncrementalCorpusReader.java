...
public abstract class AbstractIncrementalCorpusReader extends TextAnnotationReader {
    ...
    /**
     * ResourceManager must specify the fields {@link edu.cs.cogcomp.nlp.corpusreaders.CorpusReaderConfigurator}.CORPUS_NAME and
    ...
    protected void initializeReader() {
        this.sourceDirectory = resourceManager.getString(edu.cs.cogcomp.nlp.corpusreaders.CorpusReaderConfigurator.CORPUS_DIRECTORY);
        try {
