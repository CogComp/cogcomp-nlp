...
public class CoNLLNerReader extends TextAnnotationReader {
     ...
     * This writes each TextAnnotation to it's own file, using the sentence view as a guide for sentences.
     * This will requires that each TextAnnotation have a non-null ID, which will be the name of the conll file
     * for that TextAnnotation.
     * @param tas
     * @param outpath
     * @throws IOException
     */
