...
import edu.illinois.cs.cogcomp.corpusreaders.aceReader.SimpleXMLParser;
...
public class ReadACEAnnotation {
	...
	public static ACEEntityMention readEntityMention (Node node) throws XMLException {
		...
		if (null != entityMentionLDCTypeItem) entityMention.ldcType = entityMentionLDCTypeItem.getNodeValue();
