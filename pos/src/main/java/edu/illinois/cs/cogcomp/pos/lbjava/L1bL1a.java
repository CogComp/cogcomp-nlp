...
public class L1bL1a extends Classifier
{
  ...
  public Feature featureValue(Object __example)
  {
    if (!(__example instanceof Token))
    {
      ...
      System.err.println("Classifier 'L1bL1a(Token)' defined on line 139 of POSKnown.lbj received '" + type + "' as input.");
  ...
  public int hashCode() { return "L1bL1a".hashCode(); }
  public boolean equals(Object o) { return o instanceof L1bL1a; }
}
