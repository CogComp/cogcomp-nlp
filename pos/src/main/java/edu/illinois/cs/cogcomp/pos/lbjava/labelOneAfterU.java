...
public class labelOneAfterU extends Classifier
{
  ...
  public FeatureVector classify(Object __example)
  {
    if (!(__example instanceof Token))
    {
      ...
      System.err.println("Classifier 'labelOneAfterU(Token)' defined on line 83 of POSUnknown.lbj received '" + type + "' as input.");
  ...
  public int hashCode() { return "labelOneAfterU".hashCode(); }
  public boolean equals(Object o) { return o instanceof labelOneAfterU; }
}
