...
/**
 * This program uses {@link POSTagger} to tag plain text.  All output is sent
 * to <code>STDOUT</code>.
 *
 * <h4>Usage</h4>
 * <blockquote><code>
 ...
 * written in natural language (i.e., no annotations, and no preprocessing
 * has been performed).
 *
 * <h4>Output</h4>
...
public class POSTagPlain
{
    ...
    public static void main(String[] args) {
        ...
        if (args.length != 1) {
            System.err.println("usage: java edu.illinois.cs.cogcomp.lbj.pos.POSTagPlain <text file>");
            System.exit(1);
        }
