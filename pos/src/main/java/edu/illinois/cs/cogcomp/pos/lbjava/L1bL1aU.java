...
public class L1bL1aU extends Classifier
{
  ...
  public Feature featureValue(Object __example)
  {
    if (!(__example instanceof Token))
    {
      ...
      System.err.println("Classifier 'L1bL1aU(Token)' defined on line 114 of POSUnknown.lbj received '" + type + "' as input.");
  ...
  public int hashCode() { return "L1bL1aU".hashCode(); }
  public boolean equals(Object o) { return o instanceof L1bL1aU; }
}
