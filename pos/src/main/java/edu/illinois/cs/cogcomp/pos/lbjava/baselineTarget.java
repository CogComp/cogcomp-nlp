...
// 
...
public class baselineTarget extends POSBaselineLearner
{
  ...
  static
  {
    _lcFilePath = baselineTarget.class.getResource("baselineTarget.lc");

    if (_lcFilePath == null)
    {
      System.err.println("ERROR: Can't locate baselineTarget.lc in the class path.");
      System.exit(1);
    }

    _lexFilePath = baselineTarget.class.getResource("baselineTarget.lex");

    if (_lexFilePath == null)
    {
      System.err.println("ERROR: Can't locate baselineTarget.lex in the class path.");
      System.exit(1);
    }
  }
  ...
  private static void loadInstance()
  {
    if (instance == null)
    {
      instance = (baselineTarget) Learner.readLearner(_lcFilePath);
  ...
  public static baselineTarget instance;

  public static baselineTarget getInstance()
  {
    loadInstance();
    return instance;
  }

  private baselineTarget(boolean b)
  {
    super();
  ...
  {
    super("edu.illinois.cs.cogcomp.pos.lbjava.baselineTarget");
    isClone = true;
  }

	public baselineTarget(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof Token || example instanceof Object[]))
      {
        ...
        System.err.println("Classifier 'baselineTarget(Token)' defined on line 44 of POSKnown.lbj received '" + type + "' as input.");
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: edu.illinois.cs.cogcomp.pos.lbjava.baselineTarget \\");
    ...
    baselineTarget classifier = new baselineTarget();
  ...
  public int hashCode() { return "baselineTarget".hashCode(); }
  public boolean equals(Object o) { return o instanceof baselineTarget; }
  ...
  public static class Parameters extends POSBaselineLearner.Parameters
  {
    public Parameters() { super((POSBaselineLearner.Parameters) new baselineTarget(false).getParameters()); }
  }
}
