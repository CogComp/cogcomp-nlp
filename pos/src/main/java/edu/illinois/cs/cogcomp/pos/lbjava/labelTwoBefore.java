...
/**
 * Produces the POS tag label of the word two before the target word.  During the training of {@link POSTaggerKnown},
...
public class labelTwoBefore extends Classifier {
    ...
    private static final POSTaggerKnown __POSTaggerKnown = new POSTaggerKnown(knownModelFile, knownLexFile,
            baselineTarget);
