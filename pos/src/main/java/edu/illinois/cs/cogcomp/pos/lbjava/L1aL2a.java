...
public class L1aL2a extends Classifier
{
  ...
  public Feature featureValue(Object __example)
  {
    if (!(__example instanceof Token))
    {
      ...
      System.err.println("Classifier 'L1aL2a(Token)' defined on line 147 of POSKnown.lbj received '" + type + "' as input.");
  ...
  public int hashCode() { return "L1aL2a".hashCode(); }
  public boolean equals(Object o) { return o instanceof L1aL2a; }
}
