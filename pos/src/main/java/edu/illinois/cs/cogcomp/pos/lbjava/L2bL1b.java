...
public class L2bL1b extends Classifier
{
  ...
  public Feature featureValue(Object __example)
  {
    if (!(__example instanceof Token))
    {
      ...
      System.err.println("Classifier 'L2bL1b(Token)' defined on line 131 of POSKnown.lbj received '" + type + "' as input.");
  ...
  public int hashCode() { return "L2bL1b".hashCode(); }
  public boolean equals(Object o) { return o instanceof L2bL1b; }
}
