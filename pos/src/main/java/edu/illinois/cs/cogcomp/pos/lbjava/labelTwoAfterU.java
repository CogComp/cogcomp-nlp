...
public class labelTwoAfterU extends Classifier
{
  ...
  public FeatureVector classify(Object __example)
  {
    if (!(__example instanceof Token))
    {
      ...
      System.err.println("Classifier 'labelTwoAfterU(Token)' defined on line 95 of POSUnknown.lbj received '" + type + "' as input.");
  ...
  public int hashCode() { return "labelTwoAfterU".hashCode(); }
  public boolean equals(Object o) { return o instanceof labelTwoAfterU; }
}
