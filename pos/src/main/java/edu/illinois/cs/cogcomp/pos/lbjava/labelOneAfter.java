...
public class labelOneAfter extends Classifier
{
  ...
  public FeatureVector classify(Object __example)
  {
    if (!(__example instanceof Token))
    {
      ...
      System.err.println("Classifier 'labelOneAfter(Token)' defined on line 108 of POSKnown.lbj received '" + type + "' as input.");
  ...
  public int hashCode() { return "labelOneAfter".hashCode(); }
  public boolean equals(Object o) { return o instanceof labelOneAfter; }
}
