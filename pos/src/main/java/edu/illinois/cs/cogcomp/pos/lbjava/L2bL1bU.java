...
public class L2bL1bU extends Classifier
{
  ...
  public Feature featureValue(Object __example)
  {
    if (!(__example instanceof Token))
    {
      ...
      System.err.println("Classifier 'L2bL1bU(Token)' defined on line 106 of POSUnknown.lbj received '" + type + "' as input.");
  ...
  public int hashCode() { return "L2bL1bU".hashCode(); }
  public boolean equals(Object o) { return o instanceof L2bL1bU; }
}
