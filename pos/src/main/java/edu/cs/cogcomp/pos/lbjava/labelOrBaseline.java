 ...
 */
package edu.cs.cogcomp.pos.lbjava;
...
/**
 * During the training of {@link POSTaggerKnown}, return the value of {@link POSLabel}; otherwise,
...
public class labelOrBaseline extends Classifier {
    ...
    public int hashCode() {
        return "labelOrBaseline".hashCode();
    }

    public boolean equals(Object o) {
        return o instanceof labelOrBaseline;
    }
}
