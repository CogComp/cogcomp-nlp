...
/**
 * This parser takes the {@link Word}s in the representation created
 ...
 * {@link Word}s with each call to {@link edu.illinois.cs.cogcomp.lbjava.parse.Parser#next()}.
...
public class PlainToTokenParser implements Parser {
    /**
     * A parser creating a representation consisting of {@link Word}s.
     **/
