 ...
 */
package edu.cs.cogcomp.lbjava.nlp.seg;
 ...
 * on an input text using a learned {@link Word} classifier.
 * <p/>
 * <h4>Usage</h4>
 * <blockquote><code>
 ...
 * (e.g. <code>myPackage.myClass</code>) of a {@link Word}
 ...
 * {@link PlainToTokenParser} is applied to {@link WordSplitter}
 * applied to {@link SentenceSplitter} which ends up returning
 * {@link Word} objects one at a time.  If the parameter is given,
