...
import edu.cs.cogcomp.annotation.BasicAnnotatorService;
...
public class RunPipeline
{
	...
	public TextAnnotation RunPipelineOnFile(String fileName ) throws FileNotFoundException, AnnotatorException {
    ...
    public void RunPipelineWithCorpusReader(TextAnnotationReader reader )
    {
