...
public class PipelineConfigurator extends AnnotatorServiceConfigurator {
    ...
    public static final Property USE_ESA_DATALESS = new Property("useESADataless", FALSE);
    public static final Property USE_W2V_DATALESS = new Property("useW2VDataless", FALSE);
    ...
    public ResourceManager getDefaultConfig() {
        Property[] properties =
                {USE_POS, USE_LEMMA, USE_SHALLOW_PARSE, USE_DEP, USE_NER_CONLL, USE_NER_ONTONOTES,
                        ...
                        USE_ESA_DATALESS, USE_W2V_DATALESS};
