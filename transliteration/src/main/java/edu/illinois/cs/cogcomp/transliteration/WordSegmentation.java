...
//        examples = examples.Filter(delegate(String arg) {
//            for (int j = 0; j < arg.Length; j++) if (Array.IndexOf <char>(vowels, arg[j])>=0)return true;
//            return false;
//        });
//
...
//        Dictionary<int, SparseDoubleVector<String>> sVectors = probs.Split <int>(delegate(String arg) {
//            return arg.Length;
//        });
...
//        result.Sort(new Comparison<KeyValuePair<String, double>>(delegate(KeyValuePair < String,double>
//        a, KeyValuePair < String,double>b){
