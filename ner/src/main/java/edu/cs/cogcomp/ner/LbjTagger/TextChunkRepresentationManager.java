...
public class TextChunkRepresentationManager {
    ...
    public static void changeChunkRepresentation(EncodingScheme fromRep, EncodingScheme toRep,
            Data data, NEWord.LabelToLookAt labelType) {
        // Translate to BIO
    ...
    private static void Bio2Bilou(Data data, NEWord.LabelToLookAt labelType) {
    ...
    private static void Bilou2Bio(Data data, NEWord.LabelToLookAt labelType) {
        for (int docid = 0; docid < data.documents.size(); docid++) {
            ArrayList<LinkedVector> sentences = data.documents.get(docid).sentences;
            for (LinkedVector v : sentences) {
                for (int j = 0; j < v.size(); j++) {
    ...
    // ------------------- IOB1 ---------------------------
    private static void Bio2IOB(Data data, NEWord.LabelToLookAt labelType) {
        for (int docid = 0; docid < data.documents.size(); docid++) {
            ArrayList<LinkedVector> sentences = data.documents.get(docid).sentences;
            for (LinkedVector v : sentences) {
                for (int j = 0; j < v.size(); j++) {
    ...
    private static void IOB2Bio(Data data, NEWord.LabelToLookAt labelType) {
        for (int docid = 0; docid < data.documents.size(); docid++) {
            ArrayList<LinkedVector> sentences = data.documents.get(docid).sentences;
            for (LinkedVector v : sentences) {
                for (int j = 0; j < v.size(); j++) {
    ...
    private static void Bio2IOEa(Data data, NEWord.LabelToLookAt labelType) {
        for (int docid = 0; docid < data.documents.size(); docid++) {
            ArrayList<LinkedVector> sentences = data.documents.get(docid).sentences;
            for (LinkedVector v : sentences) {
                for (int j = 0; j < v.size(); j++) {
    ...
    private static void IOEa2Bio(Data data, NEWord.LabelToLookAt labelType) {
        for (int docid = 0; docid < data.documents.size(); docid++) {
            ArrayList<LinkedVector> sentences = data.documents.get(docid).sentences;
    ...
    private static void Bio2IOEb(Data data, NEWord.LabelToLookAt labelType) {
        for (int docid = 0; docid < data.documents.size(); docid++) {
            ArrayList<LinkedVector> sentences = data.documents.get(docid).sentences;
            for (LinkedVector v : sentences) {
                for (int j = 0; j < v.size(); j++) {
    ...
    private static void IOEb2Bio(Data data, NEWord.LabelToLookAt labelType) {
        for (int docid = 0; docid < data.documents.size(); docid++) {
            ArrayList<LinkedVector> sentences = data.documents.get(docid).sentences;
            for (int i = sentences.size() - 1; i >= 0; i--) {
                LinkedVector v = sentences.get(i);
