...
public class PreviousTag1Level2 extends Classifier {
    ...
    public FeatureVector classify(Object __example) {
        if (!(__example instanceof NEWord)) {
            ...
            System.err
                    .println("Classifier 'PreviousTag1Level2(NEWord)' defined on line 457 of LbjTagger.lbj received '"
                            + type + "' as input.");
    ...
    public int hashCode() {
        return "PreviousTag1Level2".hashCode();
    }

    public boolean equals(Object o) {
        return o instanceof PreviousTag1Level2;
    }
}
