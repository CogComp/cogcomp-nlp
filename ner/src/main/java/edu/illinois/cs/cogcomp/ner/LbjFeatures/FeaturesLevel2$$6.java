...
// discrete% FeaturesLevel2$$6(NEWord word) <- PreviousTag1Level2 &&
...
public class FeaturesLevel2$$6 extends Classifier {
    ...
    public FeatureVector classify(Object __example) {
        if (!(__example instanceof NEWord)) {
            ...
            System.err
                    .println("Classifier 'FeaturesLevel2$$6(NEWord)' defined on line 595 of LbjTagger.lbj received '"
                            + type + "' as input.");
    ...
    public int hashCode() {
        return "FeaturesLevel2$$6".hashCode();
    }

    public boolean equals(Object o) {
        return o instanceof FeaturesLevel2$$6;
    }
}
