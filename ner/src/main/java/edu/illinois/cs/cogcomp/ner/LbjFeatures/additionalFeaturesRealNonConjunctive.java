...
public class additionalFeaturesRealNonConjunctive extends Classifier {
    ...
    public FeatureVector classify(Object __example) {
        if (!(__example instanceof NEWord)) {
            ...
            System.err
                    .println("Classifier 'additionalFeaturesRealNonConjunctive(NEWord)' defined on line 74 of LbjTagger.lbj received '"
                            + type + "' as input.");
    ...
    public int hashCode() {
        return "additionalFeaturesRealNonConjunctive".hashCode();
    }

    public boolean equals(Object o) {
        return o instanceof additionalFeaturesRealNonConjunctive;
    }
}
