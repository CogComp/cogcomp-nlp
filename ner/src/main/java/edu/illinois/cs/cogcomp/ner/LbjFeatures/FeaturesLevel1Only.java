...
public class FeaturesLevel1Only extends Classifier
{
  ...
  private static final FeaturesLevel1Only$$5 __FeaturesLevel1Only$$5 = new FeaturesLevel1Only$$5();
  private static final FeaturesLevel1Only$$6 __FeaturesLevel1Only$$6 = new FeaturesLevel1Only$$6();
  ...
  public FeatureVector classify(Object __example)
  {
    if (!(__example instanceof NEWord))
    {
      ...
      System.err.println("Classifier 'FeaturesLevel1Only(NEWord)' defined on line 444 of LbjTagger.lbj received '" + type + "' as input.");
