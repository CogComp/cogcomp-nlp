 ...
 */
public class LaterCoNLLReaderAndWriter implements DocumentReaderAndWriter<CoreLabel> {
    ...
    private boolean keepgold = true;
    public LaterCoNLLReaderAndWriter() {
    }
    public LaterCoNLLReaderAndWriter(boolean keepgold) {
        this.keepgold = keepgold;
    }
    @Override
    ...
    public String toString() {
        return "LaterCoNLLReaderAndWriter[entitySubclassification: " + flags.entitySubclassification + ", intern: " + flags.intern + ']';
    }
    ...
    private CoreLabel makeCoreLabel(String line) {
        ...
        switch (bits.length) {
            ...
            default:
                wi.setWord(bits[5]);
                wi.setTag(bits[4]);
                wi.set(CoreAnnotations.AnswerAnnotation.class, bits[0]);
                break;
        }
    ...
    private void deEndify(List<CoreLabel> tokens) {
        ...
        IOBUtils.entitySubclassify(tokens, CoreAnnotations.AnswerAnnotation.class, flags.backgroundSymbol, "iob1", flags.intern);
    }
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        LaterCoNLLReaderAndWriter rw = new LaterCoNLLReaderAndWriter();
