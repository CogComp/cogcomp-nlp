...
public class additionalFeaturesRealConjunctive extends Classifier {
    ...
    public FeatureVector classify(Object __example) {
        if (!(__example instanceof NEWord)) {
            ...
            System.err
                    .println("Classifier 'additionalFeaturesRealConjunctive(NEWord)' defined on line 101 of LbjTagger.lbj received '"
                            + type + "' as input.");
    ...
    public int hashCode() {
        return "additionalFeaturesRealConjunctive".hashCode();
    }

    public boolean equals(Object o) {
        return o instanceof additionalFeaturesRealConjunctive;
    }
}
