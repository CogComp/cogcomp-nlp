...
public class WordEmbeddingFeatures extends Classifier {
    ...
    public FeatureVector classify(Object __example) {
        if (!(__example instanceof NEWord)) {
            ...
            System.err
                    .println("Classifier 'WordEmbeddingFeatures(NEWord)' defined on line 146 of LbjTagger.lbj received '"
                            + type + "' as input.");
    ...
    public int hashCode() {
        return "WordEmbeddingFeatures".hashCode();
    }

    public boolean equals(Object o) {
        return o instanceof WordEmbeddingFeatures;
    }
}
