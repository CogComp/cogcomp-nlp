...
public class PreviousTag1Level1 extends Classifier {
    ...
    public FeatureVector classify(Object __example) {
        if (!(__example instanceof NEWord)) {
            ...
            System.err
                    .println("Classifier 'PreviousTag1Level1(NEWord)' defined on line 325 of LbjTagger.lbj received '"
                            + type + "' as input.");
    ...
    public int hashCode() {
        return "PreviousTag1Level1".hashCode();
    }

    public boolean equals(Object o) {
        return o instanceof PreviousTag1Level1;
    }
}
