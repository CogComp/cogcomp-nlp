...
public class NETaggerLevel1 extends SparseNetworkLearner {
    ...
    private static Logger logger = LoggerFactory.getLogger(NETaggerLevel1.class);


    public NETaggerLevel1(String modelPath, String lexiconPath) {
    ...
    public int hashCode() {
        return "NETaggerLevel1".hashCode();
    }

    public boolean equals(Object o) {
        return o instanceof NETaggerLevel1;
    }
