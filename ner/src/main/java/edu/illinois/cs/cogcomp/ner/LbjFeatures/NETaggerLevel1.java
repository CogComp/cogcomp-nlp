...
public class NETaggerLevel1 extends SparseNetworkLearner
{
  ...
  static
  {
    ...
    {
      System.err.println("ERROR: Can't locate NETaggerLevel1.lex in the class path.");
      System.exit(1);
    }
  }
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof NEWord || example instanceof Object[]))
      {
        ...
        System.err.println("Classifier 'NETaggerLevel1(NEWord)' defined on line 447 of LbjTagger.lbj received '" + type + "' as input.");
