...
public class PreviousTag2Level2 extends Classifier {
    ...
    public FeatureVector classify(Object __example) {
        if (!(__example instanceof NEWord)) {
            ...
            System.err
                    .println("Classifier 'PreviousTag2Level2(NEWord)' defined on line 474 of LbjTagger.lbj received '"
                            + type + "' as input.");
    ...
    public int hashCode() {
        return "PreviousTag2Level2".hashCode();
    }

    public boolean equals(Object o) {
        return o instanceof PreviousTag2Level2;
    }
}
