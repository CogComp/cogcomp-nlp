...
// 
...
public class FeaturesLevel2 extends Classifier {
    private static final PreviousTagPatternLevel2 __PreviousTagPatternLevel2 =
            new PreviousTagPatternLevel2();
    private static final Level1AggregationFeatures __Level1AggregationFeatures =
            new Level1AggregationFeatures();
    ...
    private static final prevTagsForContextLevel2 __prevTagsForContextLevel2 =
            new prevTagsForContextLevel2();
    ...
    public FeatureVector classify(Object __example) {
        if (!(__example instanceof NEWord)) {
            ...
            System.err
                    .println("Classifier 'FeaturesLevel2(NEWord)' defined on line 595 of LbjTagger.lbj received '"
                            + type + "' as input.");
    ...
    public int hashCode() {
        return "FeaturesLevel2".hashCode();
    }

    public boolean equals(Object o) {
        return o instanceof FeaturesLevel2;
    }
