...
public class CuratorConfigurator extends Configurator {
    ...
    public static final Property CURATOR_FORCE_UPDATE = new Property("curatorForceUpdate", Configurator.FALSE);

    // CuratorClient flags
    /** If set to {@code true}, the input text will be assumed to be pre-tokenized */
    public static final Property RESPECT_TOKENIZATION = new Property("respectTokenization", Configurator.FALSE);
    /** A comma-separated list of views to add (see {@link edu.illinois.cs.cogcomp.core.datastructures.ViewNames} for a complete list of views. */
    public static final Property VIEWS_TO_ADD = new Property("viewsToAdd", ViewNames.POS + "," + ViewNames.NER_CONLL);
    ...
    public static final Property CACHE_FORCE_UPDATE = new Property("cacheForceUpdate", Configurator.FALSE);

    @Override
    public ResourceManager getDefaultConfig() {
        Property[] props = {CURATOR_HOST, CURATOR_PORT, CURATOR_FORCE_UPDATE, RESPECT_TOKENIZATION,
