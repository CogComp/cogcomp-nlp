...
/**
 * A simple {@link edu.illinois.cs.cogcomp.core.datastructures.textannotation.TextAnnotation} builder, that uses {@link edu.illinois.cs.cogcomp.curator.CuratorClient} to create a TextAnnotation and
 * populate it with {@link edu.illinois.cs.cogcomp.core.datastructures.ViewNames#TOKENS} and {@link edu.illinois.cs.cogcomp.core.datastructures.ViewNames#SENTENCE} views.
 *
...
public class CuratorTextAnnotationBuilder implements TextAnnotationBuilder {
    ...
    public TextAnnotation createTextAnnotation(String corpusId, String textId, String text) throws IllegalArgumentException {
        ...
        } catch (ServiceUnavailableException | AnnotationFailedException | SocketException | TException e) {
