...
// discrete% combinedFeatures$$6(Relation r) <- extentFeatures && extentFeatures
...
public class combinedFeatures$$6 extends Classifier
{
  private static final extentFeatures left = new extentFeatures();
  public combinedFeatures$$6()
  {
    containingPackage = "org.cogcomp.md.LbjGen";
    name = "combinedFeatures$$6";
  }
  ...
  public FeatureVector classify(Object __example)
  {
    if (!(__example instanceof Relation))
    {
      ...
      System.err.println("Classifier 'combinedFeatures$$6(Relation)' defined on line 239 of extent.lbj received '" + type + "' as input.");
  ...
  public int hashCode() { return "combinedFeatures$$6".hashCode(); }
  public boolean equals(Object o) { return o instanceof combinedFeatures$$6; }
}
