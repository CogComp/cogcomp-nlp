...
// discrete% combinedFeatures$$2(Relation r) <- POSExtent && afterHeadPOS
...
public class combinedFeatures$$2 extends Classifier
{
  private static final POSExtent left = new POSExtent();
  private static final afterHeadPOS right = new afterHeadPOS();

  public combinedFeatures$$2()
  {
    containingPackage = "org.cogcomp.md.LbjGen";
    name = "combinedFeatures$$2";
  }
  ...
  public int hashCode() { return "combinedFeatures$$2".hashCode(); }
  public boolean equals(Object o) { return o instanceof combinedFeatures$$2; }
}
