...
// discrete% combinedFeatures$$0(Relation r) <- headFeatures && extentFeatures
...
public class combinedFeatures$$0 extends Classifier
{
  private static final headFeatures left = new headFeatures();
  private static final extentFeatures right = new extentFeatures();

  public combinedFeatures$$0()
  {
    containingPackage = "org.cogcomp.md.LbjGen";
    name = "combinedFeatures$$0";
  }
  ...
  public int hashCode() { return "combinedFeatures$$0".hashCode(); }
  public boolean equals(Object o) { return o instanceof combinedFeatures$$0; }
}
