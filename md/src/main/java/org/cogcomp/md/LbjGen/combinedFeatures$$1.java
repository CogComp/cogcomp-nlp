...
// discrete% combinedFeatures$$1(Relation r) <- wordFormExtent && afterHeadPOS
...
public class combinedFeatures$$1 extends Classifier
{
  private static final wordFormExtent left = new wordFormExtent();
  private static final afterHeadPOS right = new afterHeadPOS();

  public combinedFeatures$$1()
  {
    containingPackage = "org.cogcomp.md.LbjGen";
    name = "combinedFeatures$$1";
  }
  ...
  public int hashCode() { return "combinedFeatures$$1".hashCode(); }
  public boolean equals(Object o) { return o instanceof combinedFeatures$$1; }
}
