...
// discrete% combinedFeatures$$3(Relation r) <- wordFormExtent && headLastWord
...
public class combinedFeatures$$3 extends Classifier
{
  private static final wordFormExtent left = new wordFormExtent();
  private static final headLastWord right = new headLastWord();

  public combinedFeatures$$3()
  {
    containingPackage = "org.cogcomp.md.LbjGen";
    name = "combinedFeatures$$3";
  }
  ...
  public int hashCode() { return "combinedFeatures$$3".hashCode(); }
  public boolean equals(Object o) { return o instanceof combinedFeatures$$3; }
}
