...
// discrete% combinedFeatures$$4(Relation r) <- POSExtent && headLastWord
...
public class combinedFeatures$$4 extends Classifier
{
  ...
  public int hashCode() { return "combinedFeatures$$4".hashCode(); }
  public boolean equals(Object o) { return o instanceof combinedFeatures$$4; }
}
